...
# ダイナミックメモリアロケーション <a id="SS_13"></a>
本章で扱うダイナミックメモリアロケーション([ヒープ](cpp_idioms.md#SS_20_11_1)の使用)とは、new/delete、malloc/free
によるメモリ確保/解放のことである。
...
&emsp;&emsp; [malloc/freeの問題点](dynamic_memory_allocation.md#SS_13_1)  
&emsp;&emsp; [メモリプール](dynamic_memory_allocation.md#SS_13_2)  
&emsp;&emsp;&emsp; [固定長メモリプール](dynamic_memory_allocation.md#SS_13_2_1)  
&emsp;&emsp;&emsp; [可変長メモリプール](dynamic_memory_allocation.md#SS_13_2_2)  

&emsp;&emsp; [メモリプールのエクセプション](dynamic_memory_allocation.md#SS_13_3)  
&emsp;&emsp;&emsp; [MPoolBadAlloc](dynamic_memory_allocation.md#SS_13_3_1)  
&emsp;&emsp;&emsp; [エクセプション処理機構の変更](dynamic_memory_allocation.md#SS_13_3_2)  

&emsp;&emsp; [new/deleteのオーバーロード](dynamic_memory_allocation.md#SS_13_4)  
&emsp;&emsp;&emsp; [グローバルnew/deleteのオーバーロード](dynamic_memory_allocation.md#SS_13_4_1)  
&emsp;&emsp;&emsp; [デバッグ用イテレータ](dynamic_memory_allocation.md#SS_13_4_2)  
&emsp;&emsp;&emsp; [クラスnew/deleteのオーバーロード](dynamic_memory_allocation.md#SS_13_4_3)  
&emsp;&emsp;&emsp; [new/deleteのオーバーロードのまとめ](dynamic_memory_allocation.md#SS_13_4_4)  

&emsp;&emsp; [標準ライブラリのコンテナ用アロケータ](dynamic_memory_allocation.md#SS_13_5)  
&emsp;&emsp;&emsp; [デバッグ用イテレータ](dynamic_memory_allocation.md#SS_13_5_1)  
...
## malloc/freeの問題点 <a id="SS_13_1"></a>
...
このアクセスの競合は[スピンロック](cpp_idioms.md#SS_20_11_5)(SpinLock)によって回避される。
...
[フリースタンディング環境](cpp_idioms.md#SS_20_11_8)では、sbrkのようなシステムコールは存在しないため、
...
* 複数個のメモリプールを統合的に扱う[インターフェースクラス](core_lang_spec.md#SS_18_4_11)MPool
...
なお、この実装ではmalloc/freeと同様に使用制限の少ない[スピンロック](cpp_idioms.md#SS_20_11_5)(SpinLock)を使用したが、
...
### MPoolBadAlloc <a id="SS_13_3_1"></a>
...
### エクセプション処理機構の変更 <a id="SS_13_3_2"></a>
...
コンパイラに[g++](cpp_idioms.md#SS_20_12_1)や[clang++](cpp_idioms.md#SS_20_12_2)を使っている場合、
...
## new/deleteのオーバーロード <a id="SS_13_4"></a>
...
### グローバルnew/deleteのオーバーロード <a id="SS_13_4_1"></a>
...
[一様初期化](core_lang_spec.md#SS_18_6_6)で行った方が良いが、
...
[プレースメントnew](core_lang_spec.md#SS_18_6_9)によりMPoolオブジェクトを生成する下記の関数テンプレートである。
...
### クラスnew/deleteのオーバーロード <a id="SS_13_4_3"></a>
...
* その他のクラスに対しては、[Singleton](appendix.md#SS_25_1_4)や[Named Constructor](appendix.md#SS_25_1_7)と同様な静的な方法を用いる

とし、グローバルnewを使用しないことが、より良いメモリ使用方法となり得る。

グローバルnewを使わずに動的にオブジェクトを生成するためには、

* [プレースメントnew](core_lang_spec.md#SS_18_6_9)を使う
...
これを避けるためには、
[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_20_1_4)
...
### new/deleteのオーバーロードのまとめ <a id="SS_13_4_4"></a>
...
## 標準ライブラリのコンテナ用アロケータ <a id="SS_13_5"></a>
アロケータの定義例を以下に示す。
...
C++17以降では、[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_19_6_2)を使用するべきである。

### デバッグ用イテレータ <a id="SS_13_5_1"></a>
