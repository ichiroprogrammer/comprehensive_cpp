...
このアクセスの競合は[スピンロック](cpp_idioms.md#SS_21_12_5)(SpinLock)によって回避される。
...
[フリースタンディング環境](cpp_idioms.md#SS_21_12_8)では、sbrkのようなシステムコールは存在しないため、
...
なお、この実装ではmalloc/freeと同様に使用制限の少ない[スピンロック](cpp_idioms.md#SS_21_12_5)(SpinLock)を使用したが、
