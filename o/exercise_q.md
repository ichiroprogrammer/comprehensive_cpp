...
&emsp;&emsp; [プログラミング規約(型)](exercise_q.md#SS_24_1)  
&emsp;&emsp; [プログラミング規約(クラス)](exercise_q.md#SS_24_2)  
&emsp;&emsp; [プログラミング規約(関数)](exercise_q.md#SS_24_3)  
&emsp;&emsp; [プログラミング規約(構文)](exercise_q.md#SS_24_4)  
&emsp;&emsp; [プログラミング規約(演算子)](exercise_q.md#SS_24_5)  
&emsp;&emsp; [プログラミング規約(スコープ)](exercise_q.md#SS_24_6)  
&emsp;&emsp; [プログラミング規約(その他)](exercise_q.md#SS_24_7)  
&emsp;&emsp; [SOLID](exercise_q.md#SS_24_8)  
&emsp;&emsp; [デザインパターン](exercise_q.md#SS_24_9)  
&emsp;&emsp; [開発プロセスとインフラ(全般)](exercise_q.md#SS_24_10)  
&emsp;&emsp; [テンプレートメタプログラミング](exercise_q.md#SS_24_11)  
...
## プログラミング規約(型) <a id="SS_24_1"></a>

### 演習-汎整数型の選択 <a id="SS_24_1_1"></a>
* 問題  
...
* [解答-汎整数型の選択](exercise_a.md#SS_25_1_1)


### 演習-汎整数型の演算 <a id="SS_24_1_2"></a>
* 問題
```cpp
...
* [解答例-汎整数型の演算](exercise_a.md#SS_25_1_2)


### 演習-浮動小数点型 <a id="SS_24_1_3"></a>
* 問題
```cpp
...
* [解答例-浮動小数点型](exercise_a.md#SS_25_1_3)


### 演習-定数列挙 <a id="SS_24_1_4"></a>
* 問題  
...
* [解答-定数列挙](exercise_a.md#SS_25_1_4)


### 演習-enum <a id="SS_24_1_5"></a>
* 問題
```cpp
...
* [解答例-enum](exercise_a.md#SS_25_1_5)


### 演習-配列の範囲for文 <a id="SS_24_1_6"></a>
* 問題
```cpp
...
* [解答例-配列の範囲for文](exercise_a.md#SS_25_1_6)


### 演習-エイリアス <a id="SS_24_1_7"></a>
* 問題
...
* [解答例-エイリアス](exercise_a.md#SS_25_1_7)


### 演習-constの意味 <a id="SS_24_1_8"></a>
* 問題  
...
* [解答-constの意味](exercise_a.md#SS_25_1_8)


### 演習-const/constexpr <a id="SS_24_1_9"></a>
* 問題
```cpp
...
* [解答例-const/constexpr](exercise_a.md#SS_25_1_9)


### 演習-危険なconst_cast <a id="SS_24_1_10"></a>
* 問題
```cpp
...
* 参照 [const/constexprインスタンス](programming_convention.md#SS_3_1_9)
* [解答例-危険なconst_cast](exercise_a.md#SS_25_1_10)


### 演習-リテラル <a id="SS_24_1_11"></a>
* 問題
```cpp
...
* [解答例-リテラル](exercise_a.md#SS_25_1_11)


### 演習-適切なautoの使い方 <a id="SS_24_1_12"></a>
* 問題  
...
* [解答-適切なautoの使い方](exercise_a.md#SS_25_1_12)


### 演習-ポインタの初期化 <a id="SS_24_1_13"></a>
* 問題  
...
* [解答-ポインタの初期化](exercise_a.md#SS_25_1_13)


### 演習-vector初期化 <a id="SS_24_1_14"></a>
* 問題  
  以下のコード実行後のvecの状態を選べ。
...
* [解答-vector初期化](exercise_a.md#SS_25_1_14)


### 演習-インスタンスの初期化 <a id="SS_24_1_15"></a>
* 問題
```cpp
...
* 参照 [インスタンスの初期化](programming_convention.md#SS_3_1_12)、[一様初期化](cpp_standard.md#SS_19_6_6)
* [解答例-インスタンスの初期化](exercise_a.md#SS_25_1_15)


## プログラミング規約(クラス) <a id="SS_24_2"></a>

### 演習-凝集度の意味 <a id="SS_24_2_1"></a>
* 問題  
...
* [解答-凝集度の意味](exercise_a.md#SS_25_2_1)


### 演習-凝集度の向上 <a id="SS_24_2_2"></a>
* 問題
```cpp
...
* [解答例-凝集度の向上](exercise_a.md#SS_25_2_2)


### 演習-メンバ変数の初期化方法の選択 <a id="SS_24_2_3"></a>
* 問題  
...
* [解答-メンバ変数の初期化方法の選択](exercise_a.md#SS_25_2_3)


### 演習-メンバの型 <a id="SS_24_2_4"></a>
* 問題  
  以下のA::strの意味を表すものを選べ。
...
* [解答-メンバの型](exercise_a.md#SS_25_2_4)


### 演習-メンバ変数の初期化 <a id="SS_24_2_5"></a>
* 問題
```cpp
...
* [解答例-メンバ変数の初期化](exercise_a.md#SS_25_2_5)


### 演習-スライシング <a id="SS_24_2_6"></a>
* 問題
```cpp
...
* [解答例-スライシング](exercise_a.md#SS_25_2_6)

### 演習-オブジェクトの所有権 <a id="SS_24_2_7"></a>
* 問題
```cpp
...
* [解答例-オブジェクトの所有権](exercise_a.md#SS_25_2_7)


## プログラミング規約(関数) <a id="SS_24_3"></a>

### 演習-非メンバ関数の宣言 <a id="SS_24_3_1"></a>
* 問題
```cpp
...
* [解答例-非メンバ関数の宣言](exercise_a.md#SS_25_3_1)


### 演習-メンバ関数の修飾 <a id="SS_24_3_2"></a>
* 問題
```cpp
...
* [解答例-メンバ関数の修飾](exercise_a.md#SS_25_3_2)


### 演習-特殊メンバ関数の削除 <a id="SS_24_3_3"></a>
* 問題
```cpp
...
* [解答例-特殊メンバ関数の削除](exercise_a.md#SS_25_3_3)


### 演習-委譲コンストラクタ <a id="SS_24_3_4"></a>
* 問題
```cpp
...
* [解答例-委譲コンストラクタ](exercise_a.md#SS_25_3_4)


### 演習-copyコンストラクタ <a id="SS_24_3_5"></a>
* 問題
```cpp
...
* 参照 [コンストラクタ](programming_convention.md#SS_3_3_2_2)
* [解答例-copyコンストラクタ](exercise_a.md#SS_25_3_5)


### 演習-moveコンストラクタ <a id="SS_24_3_6"></a>
* 問題
```cpp
...
* [解答例-moveコンストラクタ](exercise_a.md#SS_25_3_6)


### 演習-関数分割 <a id="SS_24_3_7"></a>
* 問題
```cpp
...
* [解答例-関数分割](exercise_a.md#SS_25_3_7)


### 演習-オーバーライド関数の修飾 <a id="SS_24_3_8"></a>
* 問題  
...
* [解答-オーバーライド関数の修飾](exercise_a.md#SS_25_3_8)


### 演習-オーバーライド/オーバーロード <a id="SS_24_3_9"></a>
* 問題
```cpp
...
* [解答例-オーバーライド/オーバーロード](exercise_a.md#SS_25_3_9)


### 演習-オーバーロードによる誤用防止 <a id="SS_24_3_10"></a>
* 問題
```cpp
...
* [解答例-オーバーロードによる誤用防止](exercise_a.md#SS_25_3_10)


### 演習-仮引数の修飾 <a id="SS_24_3_11"></a>
* 問題
```cpp
...
* [解答例-仮引数の修飾](exercise_a.md#SS_25_3_11)


### 演習-constexpr関数 <a id="SS_24_3_12"></a>
* 問題
```cpp
...
* 参照 [constexpr関数](cpp_standard.md#SS_19_5_3)
* [解答例-constexpr関数](exercise_a.md#SS_25_3_12)


### 演習-エクセプションの型 <a id="SS_24_3_13"></a>
* 問題  
...
* [解答-エクセプションの型](exercise_a.md#SS_25_3_13)


## プログラミング規約(構文) <a id="SS_24_4"></a>

### 演習-コンテナの範囲for文 <a id="SS_24_4_1"></a>
* 問題
```cpp
...
* 参照 [範囲for文](cpp_standard.md#SS_19_9_3)
* [解答例-コンテナの範囲for文](exercise_a.md#SS_25_4_1)


### 演習-ラムダ式 <a id="SS_24_4_2"></a>
* 問題
```cpp
...
* [解答例-ラムダ式](exercise_a.md#SS_25_4_2)


### 演習-ラムダ式のキャプチャ <a id="SS_24_4_3"></a>
* 問題
```cpp
...
* 参照 [ラムダ式](programming_convention.md#SS_3_4_9)
* [解答例-ラムダ式のキャプチャ](exercise_a.md#SS_25_4_3)

## プログラミング規約(演算子) <a id="SS_24_5"></a>

### 演習-条件演算子 <a id="SS_24_5_1"></a>
* 問題
```cpp
...
* [解答例-条件演算子](exercise_a.md#SS_25_5_1)


### 演習-delete <a id="SS_24_5_2"></a>
* 問題
```cpp
...
* [解答例-delete](exercise_a.md#SS_25_5_2)


### 演習-sizeof <a id="SS_24_5_3"></a>
* 問題
```cpp
...
* [解答例-sizeof](exercise_a.md#SS_25_5_3)


### 演習-dynamic_castの削除 <a id="SS_24_5_4"></a>
* 問題
```cpp
...
* [解答例-dynamic_castの削除](exercise_a.md#SS_25_5_4)


### 演習-キャスト <a id="SS_24_5_5"></a>
* 問題  
...
* [解答-キャスト](exercise_a.md#SS_25_5_5)


## プログラミング規約(スコープ) <a id="SS_24_6"></a>

### 演習-usingディレクティブ <a id="SS_24_6_1"></a>
* 問題  
...
* [解答-usingディレクティブ](exercise_a.md#SS_25_6_1)


## プログラミング規約(その他) <a id="SS_24_7"></a>

### 演習-アサーションの選択 <a id="SS_24_7_1"></a>
* 問題  
...
* [解答-アサーションの選択](exercise_a.md#SS_25_7_1)


### 演習-assert/static_assert <a id="SS_24_7_2"></a>
* 問題
```cpp
...
* [解答例-assert/static_assert](exercise_a.md#SS_25_7_2)


## SOLID <a id="SS_24_8"></a>
以下の演習問題の単体テストで使用される
...
* [解答例-SRP](exercise_a.md#SS_25_8_1)


### 演習-OCP <a id="SS_24_8_2"></a>
* 問題
```cpp
...
* [解答例-OCP](exercise_a.md#SS_25_8_2)


### 演習-LSP <a id="SS_24_8_3"></a>
* 問題
```cpp
...
* [解答例-LSP](exercise_a.md#SS_25_8_3)


### 演習-ISP <a id="SS_24_8_4"></a>
* 問題
```cpp
...
* [解答例-ISP](exercise_a.md#SS_25_8_4)


### 演習-DIP <a id="SS_24_8_5"></a>
* 問題
```cpp
...
* [解答例-DIP](exercise_a.md#SS_25_8_5)


### 演習-SOLIDの定義 <a id="SS_24_8_6"></a>
* 問題  
  下記原則群と説明群を結びつけよ。
...
* [解答-SOLIDの定義](exercise_a.md#SS_25_8_6)


## デザインパターン <a id="SS_24_9"></a>
### 演習-ガード節 <a id="SS_24_9_1"></a>
* 問題
```cpp
...
* [解答例-ガード節](exercise_a.md#SS_25_9_1)


### 演習-BitmaskType <a id="SS_24_9_2"></a>
* 問題
```cpp
...
* [解答例-BitmaskType](exercise_a.md#SS_25_9_2)


### 演習-Pimpl <a id="SS_24_9_3"></a>
* 問題
```cpp
...
* [解答例-Pimpl](exercise_a.md#SS_25_9_3)


### 演習-Accessorの副作用 <a id="SS_24_9_4"></a>
* 問題  
...
* [解答-Accessorの副作用](exercise_a.md#SS_25_9_4)


### 演習-Accessor <a id="SS_24_9_5"></a>
* 問題
```cpp
...
* [解答例-Accessor](exercise_a.md#SS_25_9_5)


### 演習-Copy-And-Swap <a id="SS_24_9_6"></a>
* 問題
```cpp
...
* [解答例-Copy-And-Swap](exercise_a.md#SS_25_9_6)


### 演習-Immutable <a id="SS_24_9_7"></a>
* 問題
```cpp
...
* [解答例-Immutable](exercise_a.md#SS_25_9_7)


### 演習-Clone <a id="SS_24_9_8"></a>
* 問題
```cpp
...
* [解答例-Clone](exercise_a.md#SS_25_9_8)


### 演習-NVI <a id="SS_24_9_9"></a>
* 問題
```cpp
...
* [解答例-NVI](exercise_a.md#SS_25_9_9)


### 演習-RAIIの効果 <a id="SS_24_9_10"></a>
* 問題  
...
* [解答-RAIIの効果](exercise_a.md#SS_25_9_10)


### 演習-RAII <a id="SS_24_9_11"></a>
* 問題
```cpp
...
* [解答例-RAII](exercise_a.md#SS_25_9_11)


### 演習-Future <a id="SS_24_9_12"></a>
* 問題
```cpp
...
* [解答例-Future](exercise_a.md#SS_25_9_12)


### 演習-DI <a id="SS_24_9_13"></a>
* 問題
```cpp
...
* [解答例-DI](exercise_a.md#SS_25_9_13)


### 演習-Singleton <a id="SS_24_9_14"></a>
* 問題
```cpp
...
* [解答例-Singleton](exercise_a.md#SS_25_9_14)


### 演習-State <a id="SS_24_9_15"></a>
* 問題
```cpp
...
* [解答例-State](exercise_a.md#SS_25_9_15)


### 演習-Null Object <a id="SS_24_9_16"></a>
* 問題
```cpp
...
* [解答例-Null Object](exercise_a.md#SS_25_9_16)


### 演習-Templateメソッド <a id="SS_24_9_17"></a>
* 問題
```cpp
...
* [解答例-Templateメソッド](exercise_a.md#SS_25_9_17)


### 演習-Factory <a id="SS_24_9_18"></a>
* 問題
```cpp
...
* [解答例-Factory](exercise_a.md#SS_25_9_18)


### 演習-Named Constructor <a id="SS_24_9_19"></a>
* 問題
```cpp
...
* [解答例-Named Constructor](exercise_a.md#SS_25_9_19)


### 演習-Proxy <a id="SS_24_9_20"></a>
* 問題
```cpp
...
* [解答例-Proxy](exercise_a.md#SS_25_9_20)


### 演習-Strategy <a id="SS_24_9_21"></a>
* 問題
```cpp
...
* [解答例-Strategy](exercise_a.md#SS_25_9_21)


### 演習-Visitor <a id="SS_24_9_22"></a>
* 問題
```cpp
...
* [解答例-Visitor](exercise_a.md#SS_25_9_22)


### 演習-CRTP <a id="SS_24_9_23"></a>
* 問題
```cpp
...
* [解答例-CRTP](exercise_a.md#SS_25_9_23)


### 演習-Observer <a id="SS_24_9_24"></a>
* 問題
```cpp
...
* [解答例-Observer](exercise_a.md#SS_25_9_24)


### 演習-デザインパターン選択1 <a id="SS_24_9_25"></a>
* 問題  
  オブジェクトの状態と、
...
* [解答-デザインパターン選択1](exercise_a.md#SS_25_9_25)


### 演習-デザインパターン選択2 <a id="SS_24_9_26"></a>
* 問題  
...
* [解答-デザインパターン選択2](exercise_a.md#SS_25_9_26)


### 演習-デザインパターン選択3 <a id="SS_24_9_27"></a>
* 問題  
...
* [解答-デザインパターン選択3](exercise_a.md#SS_25_9_27)


## 開発プロセスとインフラ(全般) <a id="SS_24_10"></a>

### 演習-プロセス分類 <a id="SS_24_10_1"></a>
* 問題  
...
* [解答-プロセス分類](exercise_a.md#SS_25_10_1)


### 演習-V字モデル <a id="SS_24_10_2"></a>
* 問題  
...
* [解答-V字モデル](exercise_a.md#SS_25_10_2)


### 演習-アジャイル <a id="SS_24_10_3"></a>
* 問題  
...
* [解答-アジャイル](exercise_a.md#SS_25_10_3)


### 演習-自動化 <a id="SS_24_10_4"></a>
* 問題  
...
* [解答-自動化](exercise_a.md#SS_25_10_4)


### 演習-単体テスト <a id="SS_24_10_5"></a>
* 問題  
...
* [解答-単体テスト](exercise_a.md#SS_25_10_5)


### 演習-リファクタリングに付随する活動 <a id="SS_24_10_6"></a>
* 問題  
...
* [解答-リファクタリングに付随する活動](exercise_a.md#SS_25_10_6)


### 演習-リファクタリング対象コード <a id="SS_24_10_7"></a>
* 問題  
...
* [解答-リファクタリング対象コード](exercise_a.md#SS_25_10_7)


### 演習-CI <a id="SS_24_10_8"></a>
* 問題  
...
* [解答-CI](exercise_a.md#SS_25_10_8)


## テンプレートメタプログラミング <a id="SS_24_11"></a>

### 演習-パラメータパック <a id="SS_24_11_1"></a>
* 問題
```cpp
...
* 参照 [パラメータパック](cpp_standard.md#SS_19_11_4)
* [解答例-パラメータパック](exercise_a.md#SS_25_11_1)


### 演習-エイリアステンプレート <a id="SS_24_11_2"></a>
* 問題
```cpp
...
* [解答例-エイリアステンプレート](exercise_a.md#SS_25_11_2)


### 演習-名前空間による修飾不要な`operator<<` <a id="SS_24_11_3"></a>
* 問題
```cpp
...
* [解答例-名前空間による修飾不要な`operator<<`](exercise_a.md#SS_25_11_3)


### 演習-std::arrayの継承 <a id="SS_24_11_4"></a>
* 問題
```cpp
...
* [解答例-std::arrayの継承](exercise_a.md#SS_25_11_4)


### 演習-SFINAEを利用しない関数テンプレートの特殊化によるis_void <a id="SS_24_11_5"></a>
* 問題
```cpp
...
* [解答例-SFINAEを利用しない関数テンプレートの特殊化によるis_void](exercise_a.md#SS_25_11_5)


### 演習-SFINAEを利用しないクラステンプレートの特殊化によるis_void <a id="SS_24_11_6"></a>
* 問題
...
* [解答例-SFINAEを利用しないクラステンプレートの特殊化によるis_void](exercise_a.md#SS_25_11_6)


### 演習-SFINAEを利用した関数テンプレートの特殊化によるis_void <a id="SS_24_11_7"></a>
* 問題
```cpp
...
* [解答例-SFINAEを利用した関数テンプレートの特殊化によるis_void](exercise_a.md#SS_25_11_7)


### 演習-SFINAEを利用したクラステンプレートの特殊化によるis_void <a id="SS_24_11_8"></a>
* 問題
```cpp
...
* [解答例-SFINAEを利用したクラステンプレートの特殊化によるis_void](exercise_a.md#SS_25_11_8)


### 演習-テンプレートテンプレートパラメータ <a id="SS_24_11_9"></a>
* 問題
```cpp
...
* [解答例-テンプレートテンプレートパラメータ](exercise_a.md#SS_25_11_9)


### 演習-テンプレートパラメータを可変長にしたstd::is_same <a id="SS_24_11_10"></a>
* 問題
```cpp
...
* [解答例-テンプレートパラメータを可変長にしたstd::is_same](exercise_a.md#SS_25_11_10)


### 演習-メンバ関数の存在の診断 <a id="SS_24_11_11"></a>
* 問題
```cpp
...
* [解答例-メンバ関数の存在の診断](exercise_a.md#SS_25_11_11)


### 演習-範囲for文のオペランドになれるかどうかの診断 <a id="SS_24_11_12"></a>
* 問題
```cpp
...
* 参照 [関数の存在の診断](template_meta_programming.md#SS_13_3_4)
* [解答例-範囲for文のオペランドになれるかどうかの診断](exercise_a.md#SS_25_11_12)


### 演習-配列の長さの取り出し <a id="SS_24_11_13"></a>
* 問題
```cpp
...
* 参照 [関数の存在の診断](template_meta_programming.md#SS_13_3_4)
* [解答例-配列の長さの取り出し](exercise_a.md#SS_25_11_13)


### 演習-配列の次元の取り出し <a id="SS_24_11_14"></a>
* 問題
```cpp
...
* [解答例-配列の次元の取り出し](exercise_a.md#SS_25_11_14)


### 演習-関数型のテンプレートパラメータを持つクラステンプレート <a id="SS_24_11_15"></a>
* 問題
```cpp
...
* [解答例-関数型のテンプレートパラメータを持つクラステンプレート](exercise_a.md#SS_25_11_15)
