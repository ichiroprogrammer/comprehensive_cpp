...
&emsp;&emsp; [型とインスタンス](term_explanation.md#SS_21_1)  
&emsp;&emsp;&emsp; [特殊メンバ関数](term_explanation.md#SS_21_1_1)  
&emsp;&emsp;&emsp;&emsp; [ゼロの原則(Rule of Zero)](term_explanation.md#SS_21_1_1_1)  
&emsp;&emsp;&emsp;&emsp; [五の原則(Rule of Five)](term_explanation.md#SS_21_1_1_2)  

&emsp;&emsp;&emsp; [オーバーライドとオーバーロードの違い](term_explanation.md#SS_21_1_2)  

&emsp;&emsp; [オブジェクトと生成](term_explanation.md#SS_21_2)  
&emsp;&emsp;&emsp; [非静的なメンバ変数の初期化](term_explanation.md#SS_21_2_1)  
&emsp;&emsp;&emsp; [オブジェクトの所有権](term_explanation.md#SS_21_2_2)  
&emsp;&emsp;&emsp;&emsp; [オブジェクトの排他所有](term_explanation.md#SS_21_2_2_1)  
&emsp;&emsp;&emsp;&emsp; [オブジェクトの共有所有](term_explanation.md#SS_21_2_2_2)  
&emsp;&emsp;&emsp;&emsp; [オブジェクトの循環所有](term_explanation.md#SS_21_2_2_3)  
&emsp;&emsp;&emsp;&emsp; [std::weak_ptr](term_explanation.md#SS_21_2_2_4)  

&emsp;&emsp;&emsp; [オブジェクトのライフタイム](term_explanation.md#SS_21_2_3)  
&emsp;&emsp;&emsp; [オブジェクトのコピー](term_explanation.md#SS_21_2_4)  
&emsp;&emsp;&emsp;&emsp; [シャローコピー](term_explanation.md#SS_21_2_4_1)  
&emsp;&emsp;&emsp;&emsp; [ディープコピー](term_explanation.md#SS_21_2_4_2)  
&emsp;&emsp;&emsp;&emsp; [スライシング](term_explanation.md#SS_21_2_4_3)  

&emsp;&emsp; [リテラル](term_explanation.md#SS_21_3)  
&emsp;&emsp;&emsp; [生文字列リテラル](term_explanation.md#SS_21_3_1)  
&emsp;&emsp;&emsp; [2進数リテラル](term_explanation.md#SS_21_3_2)  
&emsp;&emsp;&emsp; [数値リテラル](term_explanation.md#SS_21_3_3)  
&emsp;&emsp;&emsp; [ワイド文字列](term_explanation.md#SS_21_3_4)  
&emsp;&emsp;&emsp; [16進浮動小数点数リテラル](term_explanation.md#SS_21_3_5)  
&emsp;&emsp;&emsp; [ユーザー定義リテラル](term_explanation.md#SS_21_3_6)  
&emsp;&emsp;&emsp;&emsp; [ユーザ定義リテラル演算子](term_explanation.md#SS_21_3_6_1)  
&emsp;&emsp;&emsp;&emsp; [std::string型リテラル](term_explanation.md#SS_21_3_6_2)  
&emsp;&emsp;&emsp;&emsp; [std::chronoのリテラル](term_explanation.md#SS_21_3_6_3)  
&emsp;&emsp;&emsp;&emsp; [std::complexリテラル](term_explanation.md#SS_21_3_6_4)  

&emsp;&emsp;&emsp; [==演算子](term_explanation.md#SS_21_3_7)  
&emsp;&emsp;&emsp;&emsp; [メンバ==演算子](term_explanation.md#SS_21_3_7_1)  
&emsp;&emsp;&emsp;&emsp; [非メンバ==演算子](term_explanation.md#SS_21_3_7_2)  

&emsp;&emsp;&emsp; [比較演算子](term_explanation.md#SS_21_3_8)  
&emsp;&emsp;&emsp;&emsp; [std::rel_ops](term_explanation.md#SS_21_3_8_1)  
&emsp;&emsp;&emsp;&emsp; [std::tuppleを使用した比較演算子の実装方法](term_explanation.md#SS_21_3_8_2)  
&emsp;&emsp;&emsp;&emsp; [<=>演算子](term_explanation.md#SS_21_3_8_3)  
&emsp;&emsp;&emsp;&emsp; [三方比較演算子](term_explanation.md#SS_21_3_8_4)  
&emsp;&emsp;&emsp;&emsp; [spaceship operator](term_explanation.md#SS_21_3_8_5)  

&emsp;&emsp; [explicit](term_explanation.md#SS_21_4)  
&emsp;&emsp;&emsp; [暗黙の型変換](term_explanation.md#SS_21_4_1)  
&emsp;&emsp;&emsp; [暗黙の型変換抑止](term_explanation.md#SS_21_4_2)  
&emsp;&emsp;&emsp; [explicit type operator()](term_explanation.md#SS_21_4_3)  
&emsp;&emsp;&emsp; [explicit(COND)](term_explanation.md#SS_21_4_4)  

&emsp;&emsp; [シンタックス、セマンティクス](term_explanation.md#SS_21_5)  
&emsp;&emsp;&emsp; [等価性のセマンティクス](term_explanation.md#SS_21_5_1)  
&emsp;&emsp;&emsp; [copyセマンティクス](term_explanation.md#SS_21_5_2)  
&emsp;&emsp;&emsp; [moveセマンティクス](term_explanation.md#SS_21_5_3)  
&emsp;&emsp;&emsp; [MoveAssignable要件](term_explanation.md#SS_21_5_4)  
&emsp;&emsp;&emsp; [CopyAssignable要件](term_explanation.md#SS_21_5_5)  

&emsp;&emsp; [C++その他](term_explanation.md#SS_21_6)  
&emsp;&emsp;&emsp; [Most Vexing Parse](term_explanation.md#SS_21_6_1)  

&emsp;&emsp; [非ソフトウェア用語](term_explanation.md#SS_21_7)  
&emsp;&emsp;&emsp; [割れ窓理論](term_explanation.md#SS_21_7_1)  
&emsp;&emsp;&emsp; [車輪の再発明](term_explanation.md#SS_21_7_2)  
...
## 型とインスタンス <a id="SS_21_1"></a>
### 特殊メンバ関数 <a id="SS_21_1_1"></a>
特殊メンバ関数とは下記の関数を指す。
...
* [==演算子](term_explanation.md#SS_21_3_7)  
  クラス内のすべてのメンバが==をサポートしている場合、`= default`とすることで自動生成される。
* [<=>演算子](term_explanation.md#SS_21_3_8_3)  
  すべてのメンバが[<=>演算子](term_explanation.md#SS_21_3_8_3)での比較可能である場合、`= default`とすることで自動生成される。 
...
* [ゼロの原則(Rule of Zero)](term_explanation.md#SS_21_1_1_1)
* [五の原則(Rule of Five)](term_explanation.md#SS_21_1_1_2)
...
#### ゼロの原則(Rule of Zero) <a id="SS_21_1_1_1"></a>
...
#### 五の原則(Rule of Five) <a id="SS_21_1_1_2"></a>
「五の原則」は、
クラスがリソース(例: 動的メモリやファイルハンドルなど)を管理する場合、
デフォルトコンストラクタを除く[特殊メンバ関数](term_explanation.md#SS_21_1_1)、
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](term_explanation.md#SS_21_2_4_1)」参照)。

なお、「五の原則」は、「六の原則」と呼ばれることもある。
その場合、この原則が対象とする関数は、
[特殊メンバ関数](term_explanation.md#SS_21_1_1)のすべてとなる。

このガイドラインに従って、コピーやムーブを実装する場合、

* [等価性のセマンティクス](term_explanation.md#SS_21_5_1)
* [copyセマンティクス](term_explanation.md#SS_21_5_2)
* [moveセマンティクス](term_explanation.md#SS_21_5_3)

に従わなけならない。


### オーバーライドとオーバーロードの違い <a id="SS_21_1_2"></a>
下記例では、Base::g()がオーバーロードで、Derived::f()がオーバーライドである
(Derived::g()はオーバーロードでもオーバーライドでもない(「[name-hiding](cpp_standard.md#SS_19_11_9)」参照))。
...
(「[ポリモーフィックなクラス](cpp_standard.md#SS_19_3_8)」参照)。
...
## オブジェクトと生成 <a id="SS_21_2"></a>
### 非静的なメンバ変数の初期化 <a id="SS_21_2_1"></a>
非静的なメンバ変数の初期化には下記の3つの方法がある。

* [NSDMI](cpp_standard.md#SS_19_5_6)
* [初期化子リストでの初期化](cpp_standard.md#SS_19_5_7)
* [コンストラクタ内での非静的なメンバ変数の初期値の代入](cpp_standard.md#SS_19_5_8)

同一変数に対して、
「[NSDMI](cpp_standard.md#SS_19_5_6)」と「[初期化子リストでの初期化](cpp_standard.md#SS_19_5_7)」
が行われた場合、その変数に対するNSDMIは行われない。


### オブジェクトの所有権 <a id="SS_21_2_2"></a>
...
「[オブジェクトの排他所有](term_explanation.md#SS_21_2_2_1)」と「[オブジェクトの共有所有](term_explanation.md#SS_21_2_2_2)」で解説する。

#### オブジェクトの排他所有 <a id="SS_21_2_2_1"></a>
...
オブジェクトの所有権やその移動、
std::unique_ptr、std::move()、[rvalue](cpp_standard.md#SS_19_6_1_2)の関係を解説する。
...
#### オブジェクトの共有所有 <a id="SS_21_2_2_2"></a>
...
下記に示した上記クラスの単体テストにより、
オブジェクトの所有権やその移動、共有、
std::shared_ptr、std::move()、[rvalue](cpp_standard.md#SS_19_6_1_2)の関係を解説する。
...
* 下記のようなコードはstd::shared_ptrの仕様が想定するセマンティクスに沿っておらず、
  [未定義動作](cpp_standard.md#SS_19_14_3)に繋がる。
...
#### オブジェクトの循環所有 <a id="SS_21_2_2_3"></a>
...
X、Yオブジェクトへの[ハンドル](cpp_jargon.md#SS_20_1_1)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。

#### std::weak_ptr <a id="SS_21_2_2_4"></a>
std::weak_ptrは、[スマートポインタ](cpp_standard.md#SS_19_13_5)の一種である。

std::weak_ptrは参照カウントに影響を与えず、`shared_ptr`とオブジェクトを共有所有するのではなく、
その`shared_ptr`インスタンスとの関連のみを保持するのため、[オブジェクトの循環所有](term_explanation.md#SS_21_2_2_3)の問題を解決できる。

[オブジェクトの循環所有](term_explanation.md#SS_21_2_2_3)で示した問題のあるクラスの修正版を以下に示す
...
なお、上記コードは[初期化付きif文](cpp_standard.md#SS_19_8_5_3)を使うことで、
...
### オブジェクトのライフタイム <a id="SS_21_2_3"></a>
...
* prvalue(「[rvalue](cpp_standard.md#SS_19_6_1_2)」参照)のライフタイム
...
このような状態のリファレンスを[danglingリファレンス](cpp_standard.md#SS_19_7_7)と呼ぶ。
同様に、このような状態のポインタを[danglingポインタ](cpp_standard.md#SS_19_7_8)と呼ぶ。

### オブジェクトのコピー <a id="SS_21_2_4"></a>
#### シャローコピー <a id="SS_21_2_4_1"></a>
シャローコピー(浅いコピー)とは、暗黙的、
もしくは=defaultによってコンパイラが生成するようなcopyコンストラクタ、
copy代入演算子が行うコピーであり、[ディープコピー](term_explanation.md#SS_21_2_4_2)と対比的に使われる概念である。
...
#### ディープコピー <a id="SS_21_2_4_2"></a>
ディープコピーとは、[シャローコピー](term_explanation.md#SS_21_2_4_1)が発生させる問題を回避したコピーである。
...
スライシングが起こった場合、そうならないことが問題である(「[等価性のセマンティクス](term_explanation.md#SS_21_5_1)」参照)。
...
### 16進浮動小数点数リテラル <a id="SS_21_3_5"></a>
16進浮動小数点数リテラルは、
...
### ユーザー定義リテラル <a id="SS_21_3_6"></a>
[ユーザ定義リテラル演算子](term_explanation.md#SS_21_3_6_1)により定義されたリテラルを指す。

#### ユーザ定義リテラル演算子 <a id="SS_21_3_6_1"></a>
...
#### std::string型リテラル <a id="SS_21_3_6_2"></a>
...
#### std::chronoのリテラル <a id="SS_21_3_6_3"></a>
...
#### std::complexリテラル <a id="SS_21_3_6_4"></a>
...
### ==演算子 <a id="SS_21_3_7"></a>
クラスの==演算子の実装方法には、
[メンバ==演算子](term_explanation.md#SS_21_3_7_1)、[非メンバ==演算子](term_explanation.md#SS_21_3_7_2)の2つの方法がある。

#### メンバ==演算子 <a id="SS_21_3_7_1"></a>
メンバ==演算子には、[非メンバ==演算子](term_explanation.md#SS_21_3_7_2)に比べ、下記のようなメリットがある。
...
#### 非メンバ==演算子 <a id="SS_21_3_7_2"></a>
非メンバ==演算子には、[メンバ==演算子](term_explanation.md#SS_21_3_7_1)に比べ、下記のようなメリットがある。
...
* [暗黙の型変換](term_explanation.md#SS_21_4_1)を利用した以下に示すようなシンプルな記述ができる場合がある。
...
### 比較演算子 <a id="SS_21_3_8"></a>
比較演算子とは、[==演算子](--)の他に、!=、 <=、>、>= <、>を指す。
C++20から導入された[<=>演算子](term_explanation.md#SS_21_3_8_3)の定義により、すべてが定義される。

#### std::rel_ops <a id="SS_21_3_8_1"></a>
...
なお、std::rel_opsはC++20から導入された[<=>演算子](term_explanation.md#SS_21_3_8_3)により不要になったため、
非推奨とされた。

#### std::tuppleを使用した比較演算子の実装方法 <a id="SS_21_3_8_2"></a>
クラスのメンバが多い場合、[==演算子](term_explanation.md#SS_21_3_7)で示したような方法は、
...
#### <=>演算子 <a id="SS_21_3_8_3"></a>
「[std::tuppleを使用した比較演算子の実装方法](term_explanation.md#SS_21_3_8_2)」
...
#### 三方比較演算子 <a id="SS_21_3_8_4"></a>
三方比較演算子とは[<=>演算子](term_explanation.md#SS_21_3_8_3)を指す。

#### spaceship operator <a id="SS_21_3_8_5"></a>
spaceship operatorとは[<=>演算子](term_explanation.md#SS_21_3_8_3)を指す。
この名前は`<=>`が宇宙船に見えることに由来としている。

## explicit <a id="SS_21_4"></a>
...
- [暗黙の型変換](term_explanation.md#SS_21_4_1)
- [暗黙の型変換抑止](term_explanation.md#SS_21_4_2)
- [explicit type operator()](term_explanation.md#SS_21_4_3)
- [explicit(COND)](term_explanation.md#SS_21_4_4)

### 暗黙の型変換 <a id="SS_21_4_1"></a>
この節で扱う暗黙の型変換とは、
...
といったセマンティクス的観点(「[シンタックス、セマンティクス](term_explanation.md#SS_21_5)」参照)によるものである。

クラスPersonと同様に、
ほとんどのユーザ定義クラスには非explicitなコンストラクタによる暗黙の型変換は必要ない。

### 暗黙の型変換抑止 <a id="SS_21_4_2"></a>
explicit宣言されていないコンストラクタを持つクラスは、
下記のコードのように[暗黙の型変換](term_explanation.md#SS_21_4_1)が起こる。
...
C++03までは、[一様初期化](cpp_standard.md#SS_19_5_2)がサポートされていなかったため、
explicitは単一引数のコンストラクタに使用されることが一般的であった。

C++11からサポートされた[一様初期化](cpp_standard.md#SS_19_5_2)を下記のように使用することで、
暗黙の型変換を使用できる。
...
### explicit type operator() <a id="SS_21_4_3"></a>
...
### explicit(COND) <a id="SS_21_4_4"></a>
...
* 「[等価性のセマンティクス](term_explanation.md#SS_21_5_1)」を守ってる
* 「[copyセマンティクス](term_explanation.md#SS_21_5_2)」を守ってる
* 「[moveセマンティクス](term_explanation.md#SS_21_5_3)」を守っている
...
組み込みの==やオーバーロード[==演算子](term_explanation.md#SS_21_3_7)のこのような性質をここでは「等価性のセマンティクス」と呼ぶ。
...
この問題は、「[RTTI](cpp_standard.md#SS_19_3_9)」使った下記のようなコードで対処できる。
...
文字列リテラルからstd::stringへの[暗黙の型変換](term_explanation.md#SS_21_4_1)が起こるために成立する。
...
従って、これらのオブジェクトに対して[等価性のセマンティクス](term_explanation.md#SS_21_5_1)
...
下記の単体テストから明らかな通り、
「[等価性のセマンティクス](term_explanation.md#SS_21_5_1)」で示した最後の例も、copyセマンティクスを満たしていない。
...
原因は、copy代入で[スライシング](term_explanation.md#SS_21_2_4_3)が起こるためである。
...
* リソース管理   
    必須ではないが、aがポインタ等のリソースを保有している場合、
     move代入後にはそのリソースはcに移動していることが一般的である(「[rvalue](cpp_standard.md#SS_19_6_1_2)」参照)

* エクセプション安全性  
    [no-fail保証](cpp_standard.md#SS_19_12_1)をする(noexceptと宣言し、エクセプションをthrowしない)
...
```cpp
    //  example/term_explanation/semantics_ut.cpp 415
...
4. 効率性  
   ...
   これは、リソースの複製を避けることで達成される(「[moveセマンティクス](term_explanation.md#SS_21_5_3)」参照)。

5. デフォルト実装  
   move代入演算子が明示的に定義されていない場合でも、
   クラスが一定の条件(例: move不可能なメンバが存在しないこと)を満たしていれば、
   コンパイラがデフォルトの実装(「[特殊メンバ関数](term_explanation.md#SS_21_1_1)」参照)を生成する。
...
3. 正しいセマンティクス  
   copy代入によって代入元のオブジェクトが変更されてはならない(「[copyセマンティクス](term_explanation.md#SS_21_5_2)」参照)。
...
## C++その他 <a id="SS_21_6"></a>
### Most Vexing Parse <a id="SS_21_6_1"></a>
...
[初期化子リストコンストラクタ](cpp_standard.md#SS_19_5_3)の呼び出しでオブジェクトの初期化を行うことで、
このような問題を回避できる。



## 非ソフトウェア用語 <a id="SS_21_7"></a>
### 割れ窓理論 <a id="SS_21_7_1"></a>
