...
&emsp;&emsp;&emsp; [ログの取得](debug.md#SS_15_5_1)  

&emsp;&emsp; [組み込みソフト](debug.md#SS_15_6)  
&emsp;&emsp;&emsp; [モニター](debug.md#SS_15_6_1)  
&emsp;&emsp;&emsp; [メモリ保護](debug.md#SS_15_6_2)  
&emsp;&emsp;&emsp; [割り込みベクタ](debug.md#SS_15_6_3)  
&emsp;&emsp;&emsp; [assert(false)](debug.md#SS_15_6_4)  
&emsp;&emsp;&emsp; [スタック消費量の計測](debug.md#SS_15_6_5)  
...
組み込みソフトは、[フリースタンディング環境](cpp_idioms.md#SS_21_12_9)で動作させることが一般的である。
...
その一方で、[CPU例外](cpp_idioms.md#SS_21_12_11)を捕捉する処理が実装されていないことが多い。
...
[フリースタンディング環境](cpp_idioms.md#SS_21_12_9)ではこれが適切に動作しないことが多い。
