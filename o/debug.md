...
組み込みソフトは、[フリースタンディング環境](cpp_idioms.md#SS_21_12_8)で動作させることが一般的である。
...
その一方で、[CPU例外](cpp_idioms.md#SS_21_12_10)を捕捉する処理が実装されていないことが多い。
...
[フリースタンディング環境](cpp_idioms.md#SS_21_12_8)ではこれが適切に動作しないことが多い。
