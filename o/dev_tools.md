...
&emsp;&emsp; [コンパイラ](dev_tools.md#SS_15_1)  
&emsp;&emsp; [デバッガ](dev_tools.md#SS_15_2)  
&emsp;&emsp;&emsp; [printfデバッグ](dev_tools.md#SS_15_2_1)  

&emsp;&emsp; [エディタ/IDE](dev_tools.md#SS_15_3)  
&emsp;&emsp; [筆者の開発ツール環境](dev_tools.md#SS_15_4)  
&emsp;&emsp;&emsp; [vim/neovimの設定](dev_tools.md#SS_15_4_1)  

&emsp;&emsp; [費用](dev_tools.md#SS_15_5)  
  
  

## コンパイラ <a id="SS_15_1"></a>
...
* コンパイルが速い。
* カバレッジの計測ができる(「[単体テストのサポートツール](process_and_infra.md#SS_10_2_1_4)」参照)。
...
PC上のコンパイラを使用した単体テストを推奨している(「[単体テストのサポートツール](process_and_infra.md#SS_10_2_1_4)」参照)。
...
* 他の開発ツールとの連動
    * ビルドができる(「[アーキテクチャとファイル構造](architecture.md#SS_9_3)」参照)。
...
* 組み込みアプリケーションの開発では下記のようにしている。
    * 単体テスト(「[単体テストのサポートツール](process_and_infra.md#SS_10_2_1_4)」参照)に関してはlinuxと同じ。
...
### vim/neovimの設定 <a id="SS_15_4_1"></a>
参考のため、このドキュメントを作成するために筆者が使用しているvim/neovimの設定やプラグイン、
その管理方法を紹介する。
vim/neovimの設定について興味がなければ、「[費用](dev_tools.md#SS_15_5)」まで飛んでほしい。

#### 設定ファイルと管理 <a id="SS_15_4_1_1"></a>
...
#### 独自スクリプト <a id="SS_15_4_1_4"></a>
##### c/c++編集 <a id="SS_15_4_1_4_1"></a>
...
##### ファイルタイプ設定 <a id="SS_15_4_1_4_4"></a>
