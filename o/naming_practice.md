...
* 「[Name and Conquer](software_practice.md#SS_2_6)」に書かれている内容を守っている。
...
* 英文字の大小で識別子を区別しない。
  ただし、「[NVI(non virtual interface)](cpp_idioms.md#SS_20_1_7)」を使用するメンバ関数名は例外とする。
...
* 慣習に従うと機能が類推しやすいため、 
  一般的な[Accessor](cpp_idioms.md#SS_20_1_5)メンバ関数には、以下のような接頭語をつける。
