...
|機能                                                          |説明                                                                        |
|:-------------------------------------------------------------|:---------------------------------------------------------------------------|
|型推論([auto](cpp_standard.md#SS_19_10_15))                      |変数や、式の型の推論                                                        |
|[decltype](cpp_standard.md#SS_19_10_16)                                               |式の型を取得                                                                |
|[範囲for文](cpp_standard.md#SS_19_8_3)                               |インデックス変数なしのfor文                                                 |
|[初期化子リストコンストラクタ](cpp_standard.md#SS_19_5_3)  |`vector<int>` v = {1, 2, 3}; など。                                           |
|[一様初期化](cpp_standard.md#SS_19_5_2)                                          　 |コンストラクタの呼び出しを、波カッコで行う。|vector<int> v{1, 2, 3};        |
|[rvalue](cpp_standard.md#SS_19_6_1_2)/[moveセマンティクス](term_explanation.md#SS_21_5_3)            |[オブジェクトの所有権](term_explanation.md#SS_21_2_2)の移転、高速化。              |
|[rvalueリファレンス](cpp_standard.md#SS_19_7_2)                                     |テンポラリオブジェクトをバインドできる`T&&`形式のリファレンス               |
|[ラムダ式](cpp_standard.md#SS_19_9_3)                                  |関数オブジェクトをその場に書く                                              |
|[noexcept](cpp_standard.md#SS_19_12_4)                                               |関数の例外指定、例外を投げる可能性のある式かbool値を返す演算子              |
|[constexpr](cpp_standard.md#SS_19_4_1)                                              |定数式やconstexpr関数の定義                                                 |
|nullptr                                                       |ヌルポインタを表すポインタ[リテラル](term_explanation.md#SS_21_3)                          |
|インライン名前空間                                            |ネストした名前空間に透過的にアクセスする。「[名前空間](programming_convention.md#SS_3_8_2)」参照  |
|[ユーザー定義リテラル](term_explanation.md#SS_21_3_6)                                   |ユーザにより定義されたリテラル。標準ライブラリでは\_sや\_svなど             |
...
|機能                                                          |説明                                                                      |
|:-------------------------------------------------------------|:-------------------------------------------------------------------------|
|[特殊メンバ関数](term_explanation.md#SS_21_1_1)のdefault/delete 宣言|自動定義される特殊関数の制御                                                 |
|[委譲コンストラクタ](cpp_standard.md#SS_19_5_5)                                    |コンストラクタから他のコンストラクタに処理を委譲する                       |
|[NSDMI](cpp_standard.md#SS_19_5_6)                                                 |非staticメンバ変数の宣言と同時に初期値指定する                             |
|[継承コンストラクタ](cpp_standard.md#SS_19_5_4)                                    |基底クラスのコンストラクタの継承                                           |
|virtual関数のoverride/final宣言                              |「[オーバーライド](programming_convention.md#SS_3_3_2_7)」参照                                              |
|変換演算子のオーバーロードの[explicit](term_explanation.md#SS_21_4)宣言              |「 [演算子オーバーロード](programming_convention.md#SS_3_3_3_4)」参照                                       |
|friend 宣言の対象を拡張                                      |テンプレートパラメータ、エイリアスfriend 宣言できるように                  |
|メンバ関数の[rvalue修飾](cpp_standard.md#SS_19_7_9_1)/[lvalue修飾](cpp_standard.md#SS_19_7_9_2)              |オブジェクトのと値カテゴリでの呼び出し可能であることの指定                 |
|[スコープドenum](cpp_standard.md#SS_19_2_3)                     |スコープを持ち、型付の強いenum                                           |
...
|[エイリアステンプレート](cpp_standard.md#SS_19_10_11)       |エイリアスをテンプレート化できる                                                           |
|[パラメータパック](cpp_standard.md#SS_19_10_4)             |任意の数のテンプレートパラメータを受け取れるようにする                                     |
|テンプレートパラメータ型の制限の緩和|ローカル型と無名型を、テンプレート引数として使用することを許可                             |
|任意の式による[SFINAE](cpp_standard.md#SS_19_10_1)         |特定の式が[ill-formed](cpp_standard.md#SS_19_14_1)か否かで、その関数をオーバーロード解決に含めるかどうかを決定する|
|テンプレートのエクスポート機能      |削除                                                                                       |
...
|[生文字列リテラル](term_explanation.md#SS_21_3_1) |文字列リテラルにRプレフィックスを付けることで、エスケープシーケンスを無視する。  |
|char16_tとchar32_t                        |UTF-16とUTF-32の文字型                                                           |
|UTF-8文字列リテラル                       |char の文字列をUTF-8エンコーディングするプレフィックス                           |
|[属性構文](cpp_standard.md#SS_19_8_1)                           |[[attr]]構文による属性指定。[[noreturn]]など。「[return文](programming_convention.md#SS_3_4_7)」参照            |
...
|機能                |説明                                 |
|:-------------------|:------------------------------------|
|[std::move](cpp_standard.md#SS_19_13_1_1)    |[moveセマンティクス](term_explanation.md#SS_21_5_3)の利用      |
|[std::forward](cpp_standard.md#SS_19_13_1_2) |[perfect forwarding](cpp_standard.md#SS_19_7_5)の実装、利用|

#### stdコンテナ <a id="SS_18_1_6_2"></a>
[コンテナ](cpp_standard.md#SS_19_13_6)全般が[moveセマンティクス](term_explanation.md#SS_21_5_3)に対応したため、
...
[rvalue](cpp_standard.md#SS_19_6_1_2)オブジェクトも受け取れて、
...
|[std::forward_list](cpp_standard.md#SS_19_13_6_1_1)        |このは単方向リンクリストの実装である。                                              |
|[std::unordered_map](cpp_standard.md#SS_19_13_6_3_2)       |同一キーの要素を複数格納しない、格納順が規定されていない連想配列の実装であるである。|
|[std::unordered_set](cpp_standard.md#SS_19_13_6_3_1)       |同一キーの要素を複数格納できず、格納順が規定されていないコンテナである。            |
|[std::type_index](cpp_standard.md#SS_19_13_6_3_3)          |型情報型を連想コンテナのキーとして使用するためのクラス。                            |

#### 並列処理 <a id="SS_18_1_6_3"></a>
|機能                          | 説明                                                    |
|:----------------------------:|:--------------------------------------------------------|
| [std::thread](cpp_standard.md#SS_19_13_3_1)           | スレッドの生成                                          |
| [std::atomic](cpp_standard.md#SS_19_13_3_3)           | 単純なオブジェクトのアトミック処理                      |
| [std::mutex](cpp_standard.md#SS_19_13_3_2)            | スレッド間の競合の回避                                  |
| [std::lock_guard](cpp_standard.md#SS_19_13_4_1)       | ミューテックスのロック/アンロックを管理するためクラス   |
| [std::unique_lock](cpp_standard.md#SS_19_13_4_2)      | ミューテックスのロック/アンロックを管理するためクラス   |
| [std::scoped_lock](cpp_standard.md#SS_19_13_4_3)      | ミューテックスのロック/アンロックを管理するためクラス   |
...
|機能                                                  |説明                                                                             |
|:-----------------------------------------------------|:--------------------------------------------------------------------------------|
|[2進数リテラル](term_explanation.md#SS_21_3_2)                                  |2進数を表す0bもしくは0Bプレフィックスを付けた数値リテラルの記述を可能に          |
|[関数の戻り値型auto](cpp_standard.md#SS_19_10_20)                             |戻り値の型を後置する関羽鵜テンプレート/関数定義とラムダ式の戻り値型にautoに      |
|[decltype(auto)](cpp_standard.md#SS_19_10_17)                                 |decltypeの規則による変数の型推論                                                 |
|[ラムダ式](cpp_standard.md#SS_19_9_3)の初期化キャプチャ        |キャプチャに代入構文を導入し、一つの変数に複数のキャプチャ方法を指定可能にする   |
|[ジェネリックラムダ](cpp_standard.md#SS_19_10_6)                             |ラムダ式のパラメータを auto にすることで、ジェネリックな関数呼び出しに           |
|[変数テンプレート](cpp_standard.md#SS_19_10_10)          |変数定義時のテンプレート指定を可能に                                             |
|constexpr関数内での条件分岐とループの文を許可         |[constexpr if文](cpp_standard.md#SS_19_10_12)                                                            |
|structの[NSDMI](cpp_standard.md#SS_19_5_6)の対応                            |                                                                                 |
|structのネストする初期化における波カッコ省略を許可    |一様初期化と初期化子リストを組み合わせた際、二重に波カッコが不要に               |
|[[deprecated]]属性                                    |「[属性構文](cpp_standard.md#SS_19_8_1)」参照                                                          |
|[数値リテラル](term_explanation.md#SS_21_3_3)の桁区切り文字                     |シングルクォーテーションで数値リテラルを桁区切りする                             |
|サイズ付きデアロケーション                            |[グローバルnew/deleteのオーバーロードの実装](dynamic_memory_allocation.md#SS_14_2_2)                                |
|[heap allocation elision](cpp_standard.md#SS_19_15_3)                        |動的メモリ確保の省略(heap allocation elision)の許可                              |
...
|[std::string型リテラル](term_explanation.md#SS_21_3_6_2)                      |                                                          |
|[std::chronoのリテラル](term_explanation.md#SS_21_3_6_3) |                                                          |
|[std::complexリテラル](term_explanation.md#SS_21_3_6_4)  |                                                          |
...
|機能                                            |説明                                                                             |
|:-----------------------------------------------|:--------------------------------------------------------------------------------|
|[16進浮動小数点数リテラル](term_explanation.md#SS_21_3_5)                 |16進数表記で浮動小数点数リテラルを記述できるようにする                           |
...
|[[maybe_unused]]属性                            |「[属性構文](cpp_standard.md#SS_19_8_1)」参照                                                          | 
|[[nodiscard]]属性                               |「[属性構文](cpp_standard.md#SS_19_8_1)」、[グローバルnew/deleteのオーバーロードの実装](dynamic_memory_allocation.md#SS_14_2_2)」参照     |
|[RVO(Return Value Optimization)](cpp_standard.md#SS_19_15_1)           |右辺値を変数の初期化のために使用する場合、コピーもムーブも省略することを保証     |
|[演算子のオペランドの評価順位](cpp_standard.md#SS_19_14_12)             |C++14まで未規定であった部分式の評価順序を規定                                    |
|enum class変数の初期値のルール変更              |「[スコープドenum](cpp_standard.md#SS_19_2_3)」、 「[underlying type](cpp_standard.md#SS_19_2_4)」参照                       |
|[newのアライメント指定](cpp_improve.md#SS_18_3_1_2)                    |                                                                                 |
|[初期化付きif/switch文](cpp_standard.md#SS_19_8_5)                    |if文とswitch文の条件式と初期化を分離する構文                                     |
|[[fallthrough]]属性                             |「[属性構文](cpp_standard.md#SS_19_8_1)」参照                                                          |
|[constexpr if文](cpp_standard.md#SS_19_10_12)                           |if constexpr(cond) とすることで、その if 文はコンパイル時に処理                  |
...
|[constexprラムダ](cpp_standard.md#SS_19_4_8) |ラムダ式の関数オブジェクトのconstexpr指定を可能に                                |
|[std::optional](cpp_standard.md#SS_19_13_7)                            |関数の戻り値の無効表現を行うためのクラステンプレート                             |
|[std::variant](cpp_standard.md#SS_19_13_8)                             |型安全なunion機能を提供するクラステンプレート                                    |
...
|機能                                           |説明                                                                                                |
|:----------------------------------------------|:---------------------------------------------------------------------------------------------------|
|[三方比較演算子](term_explanation.md#SS_21_3_8_4)                          |`<=>`/`==`による比較演算子の自動定義                                                                |
|ビットフィールドのメンバ変数初期化             |ビットフィールドメンバ変数のデフォルト値を設定する構文を追加                                        |
|[explicit(COND)](term_explanation.md#SS_21_4_4)                          |explicit(true/false) のように explicit にboolパラメータを指定できるようにする                       |
|const修飾されたメンバポインタの制限を修正      |`.*`演算子での[lvalue](cpp_standard.md#SS_19_6_1_1)のconstメンバ関数呼び出しを許可                                          |
|デフォルトコピーコンストラクタの規約のバグ修正 |デフォルトのコピーコンストラクタと引数が非constなコンストラクタが衝突する問題を修正                 |
|特殊化のアクセスチェック                       |                                                                                                    |
|[[no_unique_address]]属性追加                  |空の型のオブジェクトをほかのオブジェクトと共有する最適化を許可。「[属性構文](cpp_standard.md#SS_19_8_1)」参照             |
...
|機能                                                   |説明                                                                            |
|:------------------------------------------------------|:-------------------------------------------------------------------------------|
|[コンセプト](cpp_standard.md#SS_19_10_3)                                      |キーワードconcept、requiresの導入。テンプレートパラメータの制約。               |
|[autoパラメータによる関数テンプレートの簡易定義](cpp_standard.md#SS_19_10_13)  |[ジェネリックラムダ](cpp_standard.md#SS_19_10_6)と同様に関数パラメータをの型をautoにできる。           |
