...
c++20から導入された[コンセプト](core_lang_spec.md#SS_18_11_3)によりジェネリックプログラミングは、
開発容易性、可読性、保守性が大きく向上しため、この章のコード例には、
[コンセプト](core_lang_spec.md#SS_18_11_3)(`concept`, `requires`)を多用した。
...
&emsp;&emsp; [ログ取得ライブラリの開発](template_meta_programming.md#SS_12_1)  
&emsp;&emsp;&emsp; [要件](template_meta_programming.md#SS_12_1_1)  
&emsp;&emsp;&emsp; [ログ取得ライブラリのインターフェース](template_meta_programming.md#SS_12_1_2)  
&emsp;&emsp;&emsp; [パラメータパックを使用したテクニック](template_meta_programming.md#SS_12_1_3)  
&emsp;&emsp;&emsp; [Loggerの実装](template_meta_programming.md#SS_12_1_4)  
&emsp;&emsp;&emsp; [ユーザ定義型とそのoperator\<\<のname lookup](template_meta_programming.md#SS_12_1_5)  
&emsp;&emsp;&emsp; [Ints_tのログ登録](template_meta_programming.md#SS_12_1_6)  

&emsp;&emsp; [Nstdライブラリの開発](template_meta_programming.md#SS_12_2)  
&emsp;&emsp;&emsp; [Nstdライブラリを使用したリファクタリング](template_meta_programming.md#SS_12_2_1)  
&emsp;&emsp;&emsp; [安全なvector](template_meta_programming.md#SS_12_2_2)  
&emsp;&emsp;&emsp; [安全な配列型コンテナ](template_meta_programming.md#SS_12_2_3)  
&emsp;&emsp;&emsp; [初期化子リストの副作用](template_meta_programming.md#SS_12_2_4)  

&emsp;&emsp; [メタ関数のテクニック](template_meta_programming.md#SS_12_3)  
&emsp;&emsp;&emsp; [is_void_xxxの実装](template_meta_programming.md#SS_12_3_1)  
&emsp;&emsp;&emsp; [is_same_xxxの実装](template_meta_programming.md#SS_12_3_2)  
&emsp;&emsp;&emsp; [AreConvertibleXxxの実装](template_meta_programming.md#SS_12_3_3)  
&emsp;&emsp;&emsp; [関数の存在の診断](template_meta_programming.md#SS_12_3_4)  

&emsp;&emsp; [Nstdライブラリの開発2](template_meta_programming.md#SS_12_4)  
&emsp;&emsp;&emsp; [SafeArray2の開発](template_meta_programming.md#SS_12_4_1)  
&emsp;&emsp;&emsp; [Nstd::SafeIndexの開発](template_meta_programming.md#SS_12_4_2)  
&emsp;&emsp;&emsp; [Nstd::SafeIndexのoperator\<\<の開発](template_meta_programming.md#SS_12_4_3)  
&emsp;&emsp;&emsp; [コンテナ用Nstd::operator\<\<の開発](template_meta_programming.md#SS_12_4_4)  

&emsp;&emsp; [Nstdライブラリの開発3(浮動小数点関連)](template_meta_programming.md#SS_12_5)  
&emsp;&emsp;&emsp; [浮動小数点の比較](template_meta_programming.md#SS_12_5_1)  
&emsp;&emsp;&emsp; [固定小数点クラス](template_meta_programming.md#SS_12_5_2)  
&emsp;&emsp;&emsp; [固定小数点リテラル](template_meta_programming.md#SS_12_5_3)  
&emsp;&emsp;&emsp; [有理数クラス](template_meta_programming.md#SS_12_5_4)  
&emsp;&emsp;&emsp; [有理数リテラル](template_meta_programming.md#SS_12_5_5)  

&emsp;&emsp; [ログ取得ライブラリの開発2](template_meta_programming.md#SS_12_6)  
&emsp;&emsp; [その他のテンプレートテクニック](template_meta_programming.md#SS_12_7)  
&emsp;&emsp;&emsp; [forwardingリファレンスとstd::forward](template_meta_programming.md#SS_12_7_1)  
&emsp;&emsp;&emsp; [ジェネリックラムダによる関数内での関数テンプレートの定義](template_meta_programming.md#SS_12_7_2)  
&emsp;&emsp;&emsp; [クラステンプレートと継承の再帰構造](template_meta_programming.md#SS_12_7_3)  
&emsp;&emsp;&emsp; [意図しないname lookupの防止](template_meta_programming.md#SS_12_7_4)  
&emsp;&emsp;&emsp; [Nstd::Type2Strの開発](template_meta_programming.md#SS_12_7_5)  
&emsp;&emsp;&emsp; [静的な文字列オブジェクト](template_meta_programming.md#SS_12_7_6)  
&emsp;&emsp;&emsp; [関数型をテンプレートパラメータで使う](template_meta_programming.md#SS_12_7_7)  

&emsp;&emsp; [注意点まとめ](template_meta_programming.md#SS_12_8)  
...
### ログ取得ライブラリのインターフェース <a id="SS_12_1_2"></a>
...
これは避けるべきなので、「[Singleton](appendix.md#SS_25_1_4)」で述べた構造を導入すると、
...
[パラメータパック](core_lang_spec.md#SS_18_11_4)を使って実装するべきである。

### パラメータパックを使用したテクニック <a id="SS_12_1_3"></a>
[パラメータパック](core_lang_spec.md#SS_18_11_4)を使用するには独特なテクニックが必要となるため、まずは単純な例から説明する。
...
* 可変長引数を持つ
* [算術型](core_lang_spec.md#SS_18_1_3)の引数と戻り値を持つ
* すべての引数の和を返す
...
なお、上記コードで使用した[std::is_same](stdlib_and_concepts.md#SS_19_2_4)は、
...
[演習-パラメータパック](exercise_q.md#SS_21_11_1)  

#### パラメータパックの畳みこみ式 <a id="SS_12_1_3_1"></a>
...
#### 前から演算するパラメータパック <a id="SS_12_1_3_2"></a>
...
(「[浮動小数点型](core_lang_spec.md#SS_18_1_12)」参照)
...
### ユーザ定義型とそのoperator\<\<のname lookup <a id="SS_12_1_5"></a>

ここで、一旦Logging::Loggerの開発を止め、
Logging::Logger::set_innerでのApp::operator<<の[name lookup](core_lang_spec.md#SS_18_12_2)について考えてみることにする。
...
その認識とは、「テンプレート内の識別子の[name lookup](core_lang_spec.md#SS_18_12_2)は、
それがインスタンス化される時に行われる」というものであり、これにより
「 Logging::Loggerのname lookupは単体テスト内で行われる。
それはApp::operator<<宣言後であるためコンパイルできる」と考えることができるが、
[two phase name lookup](core_lang_spec.md#SS_18_12_3)で行われるプロセスと反するため誤りである。
...
[ADL](core_lang_spec.md#SS_18_12_5)(実引数依存探索)が働く。
また、Logging::Logger::set_inner(x)はテンプレートであるため、[two phase name lookup](core_lang_spec.md#SS_18_12_3)
が使用される。
...
instsの[関連名前空間](core_lang_spec.md#SS_18_12_6)もstdであり、Appではない。
その結果App::operator<<は発見できず、このようなエラーになった。

LOGGERからApp::operator<<を使う場合の単体テストは下記のようになるが、
[ADL](core_lang_spec.md#SS_18_12_5)によってLogging::Logger::set_inner(ints)内に導入される名前空間はstdのみであり、
前記単体テスト同様にコンパイルできない。
...
* [operator\<\<をstd内で宣言する](template_meta_programming.md#SS_12_1_6_1)
* [operator\<\<をグローバル名前空間内で宣言する](template_meta_programming.md#SS_12_1_6_2)
* [operator\<\<をLogging内で宣言する](template_meta_programming.md#SS_12_1_6_3)
* [Logging::Logger::set_inner(ints)内でusing namespace Appを行う](template_meta_programming.md#SS_12_1_6_4)
* [Ints_tを構造体としてApp内に宣言する](template_meta_programming.md#SS_12_1_6_5)
* [operator\<\<を使わない](template_meta_programming.md#SS_12_1_6_6)

のようにいくつか考えられる。以下では、順を追ってこれらの問題点について解説を行う。


#### operator\<\<をstd内で宣言する <a id="SS_12_1_6_1"></a>
ここで解決したい問題は、すでに示した通り、
「[ADL](core_lang_spec.md#SS_18_12_5)によってLogging::Logger::set_inner(ints)内に導入される名前空間はstdである」
...
上記コードは[two phase name lookup](core_lang_spec.md#SS_18_12_3)等の効果により、想定通りコンパイルできるが、
...
#### operator\<\<をグローバル名前空間内で宣言する <a id="SS_12_1_6_2"></a>
すでに述べた通り、
...
このドキュメントで使用している[g++](cpp_idioms.md#SS_20_12_1)ではこのコードはコンパイルでき、
動作も問題ないように思われるが、[clang++](cpp_idioms.md#SS_20_12_2)では以下のようなエラーが発生し、コンパイルできない。
...
この理由は「[two phase name lookup](core_lang_spec.md#SS_18_12_3)」の後半で詳しく解説したので、ここでは繰り返さないが、
...
* operator<<(std::ostream& os, App::Ints_t const& ints)
  ...
  (「[割れ窓理論](cpp_idioms.md#SS_20_13_2)」参照)になってしまうかもしれない)。
...
#### operator\<\<をLogging内で宣言する <a id="SS_12_1_6_3"></a>
...
動作はするものの、当然ながら結果は「[operator\<\<をグローバル名前空間内で宣言する](template_meta_programming.md#SS_12_1_6_2)」
で述べた状況とほぼ同様であるため、このアイデアを採用することはできない。

#### Logging::Logger::set_inner(ints)内でusing namespace Appを行う <a id="SS_12_1_6_4"></a>
...
#### Ints_tを構造体としてApp内に宣言する <a id="SS_12_1_6_5"></a>

App::Ints_t用のoperator<<がLogging::Logger::set_inner内でname lookup出来ない理由は、
これまで述べてきたようにApp::Inst_tの[関連名前空間](core_lang_spec.md#SS_18_12_6)がAppではなく、stdになってしまうからである。

これを回避するためにはその原因を取り払えばよく、
つまり、App::Inst_tの[関連名前空間](core_lang_spec.md#SS_18_12_6)がAppになるようにすればよい。
...
* using宣言によりstd::vectorのすべてのコンストラクタをApp::Ints_tに導入
  (「[継承コンストラクタ](core_lang_spec.md#SS_18_6_1_2)」参照)

としているため、エイリアスで宣言されたInts_tと等価である。
C++03では、[継承コンストラクタ](core_lang_spec.md#SS_18_6_1_2)が使えなかったため、
上記のような構造体を定義するためには、
...
#### operator\<\<を使わない <a id="SS_12_1_6_6"></a>
...
#### Ints_tのログ登録のまとめ <a id="SS_12_1_6_7"></a>
...
### Nstdライブラリを使用したリファクタリング <a id="SS_12_2_1"></a>
すでに述べた通り、「[operator\<\<を使わない](template_meta_programming.md#SS_12_1_6_6)」で導入したコードは、Nstdで定義するべきである。
...
[演習-std::arrayの継承](exercise_q.md#SS_21_11_4)  

### 安全な配列型コンテナ <a id="SS_12_2_3"></a>
...
これを初期化するためには初期化子リスト
(「[初期化子リストコンストラクタ](core_lang_spec.md#SS_18_6_1_1)」、
「[一様初期化](core_lang_spec.md#SS_18_6_6)」参照)を用いるのが良い。
...
* [SFINAE](core_lang_spec.md#SS_18_11_1)

等のメタ関数系のテクニックが必要になるため、
まずはこれらを含めたテンプレートのテクニックについて解説し、
その後SafeArray2を見ていくことにする。

## メタ関数のテクニック <a id="SS_12_3"></a>
本節では、[type_traits](stdlib_and_concepts.md#SS_19_2)の[メタ関数](core_lang_spec.md#SS_18_11_2)の実装等で広く使われいる下記のようなテクニックを

- [std::is_void](stdlib_and_concepts.md#SS_19_2_7)と同等のメタ関数を[is_void_xxxの実装](template_meta_programming.md#SS_12_3_1)
- [std::is_same](stdlib_and_concepts.md#SS_19_2_4)と同等のメタ関数を[is_same_xxxの実装](template_meta_programming.md#SS_12_3_2)
- std::is_convertibleと同等のメタ関数を[AreConvertibleXxxの実装](template_meta_programming.md#SS_12_3_3)

で紹介する。


[演習-エイリアステンプレート](exercise_q.md#SS_21_11_2)  


### is_void_xxxの実装 <a id="SS_12_3_1"></a>
...
|is_void_xxx                  |実装方法                                               |
|-----------------------------|-------------------------------------------------------|
|[is_void_f](template_meta_programming.md#SS_12_3_1_1)             |関数テンプレートの特殊化                               |
|[is_void_s](template_meta_programming.md#SS_12_3_1_2)             |クラステンプレートの特殊化                             |
|[is_void_sfinae_f](template_meta_programming.md#SS_12_3_1_3)      |FINAEと関数テンプレートのオーバーロード                |
|[is_void_sfinae_s](template_meta_programming.md#SS_12_3_1_4)      |FINAEとクラステンプレートの特殊化                      |
|[is_void_concept_s](template_meta_programming.md#SS_12_3_1_5)     |コンセプトとクラステンプレートの特殊化                 |
|[is_void_ena_s](template_meta_programming.md#SS_12_3_1_6)         |std::enable_ifによるSFINAEとクラステンプレートの特殊化 |
|[is_void_cond_s](template_meta_programming.md#SS_12_3_1_7)        |std::conditionalと関数テンプレートの特殊化             |
...
[演習-SFINAEを利用しない関数テンプレートの特殊化によるis_void](exercise_q.md#SS_21_11_5)

#### is_void_s <a id="SS_12_3_1_2"></a>
...
[演習-SFINAEを利用しないクラステンプレートの特殊化によるis_void](exercise_q.md#SS_21_11_6)

#### is_void_sfinae_f <a id="SS_12_3_1_3"></a>
[SFINAE](core_lang_spec.md#SS_18_11_1)を使用した関数テンプレートis_void_sfinae_fの実装は以下のようになる。
...
であるため、Tがvoidの時のみ[name lookup](core_lang_spec.md#SS_18_12_2)の対象になる。
...
であるため、Tが非voidの時のみ[name lookup](core_lang_spec.md#SS_18_12_2)の対象になる。
...
[演習-SFINAEを利用した関数テンプレートの特殊化によるis_void](exercise_q.md#SS_21_11_7)

#### is_void_sfinae_s <a id="SS_12_3_1_4"></a>
[SFINAE](core_lang_spec.md#SS_18_11_1)を使用したクラステンプレートis_void_sfinae_sの実装は以下のようになる。
...
is_void_sfinae_sの特殊化が[name lookup](core_lang_spec.md#SS_18_12_2)の対象の中に見つからなかった場合、
これが使われる。
...
「[is_void_ena_s](template_meta_programming.md#SS_12_3_1_6)の実装」でその例を示す。

[演習-SFINAEを利用したクラステンプレートの特殊化によるis_void](exercise_q.md#SS_21_11_8)

#### is_void_concept_s <a id="SS_12_3_1_5"></a>
[is_void_sfinae_s](template_meta_programming.md#SS_12_3_1_4)の実装で使用したSFINAEを回避し、
コンセプトを使用することで可読性の向上が見込める。
以下の実装で使用した[same_as](template_meta_programming.md#SS_12_3_2_6)は\<concepts>で定義されているコンセプトと同様のものである。
...
以下に示した通り、[is_void_sfinae_s](template_meta_programming.md#SS_12_3_1_4)の実装で示した定数テンプレートのテストと同様になっている。
...
#### is_void_ena_s <a id="SS_12_3_1_6"></a>
[std::enable_if](stdlib_and_concepts.md#SS_19_2_5)による[SFINAE](core_lang_spec.md#SS_18_11_1)とクラステンプレートの特殊化を使用した
...
この例では、「[is_void_sfinae_s](template_meta_programming.md#SS_12_3_1_4)の実装」の
...
で行っている。
std::enable_ifの値パラメータis_void_f\<T>()は、「[is_void_f](template_meta_programming.md#SS_12_3_1_1)の実装」で示したものである。

単体テストは、「[is_void_sfinae_s](template_meta_programming.md#SS_12_3_1_4)の実装」で示したものとほぼ同様で、以下のようになる。
...
#### is_void_cond_s <a id="SS_12_3_1_7"></a>
[std::conditional](stdlib_and_concepts.md#SS_19_2_6)と関数テンプレートの特殊化を使用したis_void_cond_sの実装は以下のようになる。
...
std::conditionalの値パラメータis_void_f\<T>()は、「[is_void_f](template_meta_programming.md#SS_12_3_1_1)の実装」で示したものである。
この例では、[SFINAE](core_lang_spec.md#SS_18_11_1)もクラステンプレートの特殊化も使用していないが、
下記単体テストからわかる通り、「[is_void_sfinae_s](template_meta_programming.md#SS_12_3_1_4)の実装」と同じ機能を備えている。
...
### is_same_xxxの実装 <a id="SS_12_3_2"></a>
...
|is_same_xxx                   |実装方法                                               |
|------------------------------|-------------------------------------------------------|
|[is_same_f](template_meta_programming.md#SS_12_3_2_1)              |関数テンプレートのオーバーロード                       |
|[is_same_v](template_meta_programming.md#SS_12_3_2_2)              |定数テンプレートの特殊化                               |
|[is_same_s](template_meta_programming.md#SS_12_3_2_3)              |クラステンプレートの特殊化                             |
|[is_same_sfinae_f](template_meta_programming.md#SS_12_3_2_4)       |SFINAEと関数テンプレート/関数のオーバーロード          |
|[is_same_sfinae_s](template_meta_programming.md#SS_12_3_2_5)       |SFINAEとクラステンプレートの特殊化                     |
|[same_as](template_meta_programming.md#SS_12_3_2_6)                |[コンセプト](core_lang_spec.md#SS_18_11_3)よるis_same_sfinae_sと同一の機能      |
|[is_same_templ](template_meta_programming.md#SS_12_3_2_7)          |テンプレートテンプレートパラメータ                     |
|[IsSameSomeOf](template_meta_programming.md#SS_12_3_2_8)           |パラメータパックと再帰                                 |
|[OneOf](template_meta_programming.md#SS_12_3_2_9)                  |IsSameSomeOfをコンセプトに                             |

#### is_same_f <a id="SS_12_3_2_1"></a>
...
「[is_same_v](template_meta_programming.md#SS_12_3_2_2)の実装」と同様に単純であるため、解説は不要だろう。 単体テストは以下のようになる。
...
#### is_same_sfinae_f <a id="SS_12_3_2_4"></a>
...
#### is_same_sfinae_s <a id="SS_12_3_2_5"></a>
...
「[is_void_sfinae_s](template_meta_programming.md#SS_12_3_1_4)の実装」とほぼ同様であるため、解説は不要だろう。 
単体テストは以下のようになる。
...
#### same_as <a id="SS_12_3_2_6"></a>
[SFINAE](core_lang_spec.md#SS_18_11_1)による[is_same_sfinae_s](template_meta_programming.md#SS_12_3_2_5)の難解なコードを[コンセプト](core_lang_spec.md#SS_18_11_3)
...
「[is_same_s](template_meta_programming.md#SS_12_3_2_3)」で紹介した特殊化のテクニックを下記のように使用することができる。
...
#### is_same_templ <a id="SS_12_3_2_7"></a>
...
[演習-テンプレートテンプレートパラメータ](exercise_q.md#SS_21_11_9)

#### IsSameSomeOf <a id="SS_12_3_2_8"></a>
IsSameSomeOfはこれまでの例とは少々異なり、

* 第1パラメータが第2パラメータ以降で指定された型のどれかと一致する
  SameAsSomeOfという名前の[コンセプト](core_lang_spec.md#SS_18_11_3)を[畳み込み式](core_lang_spec.md#SS_18_11_5)を使用し定義する
...
Usが1つだった場合、SameAsSomeOfは処理をstd::same_as(「[same_as](template_meta_programming.md#SS_12_3_2_6)」参照)に委譲する。
...
[演習-テンプレートパラメータを可変長にしたstd::is_same](exercise_q.md#SS_21_11_10)

#### OneOf <a id="SS_12_3_2_9"></a>
OneOfは、[IsSameSomeOf](template_meta_programming.md#SS_12_3_2_8)同様の機能を持つコンセプトである。
OneOfの実装にはシンプルに記述するための[畳み込み式](core_lang_spec.md#SS_18_11_5)を使用した。
...
### AreConvertibleXxxの実装 <a id="SS_12_3_3"></a>
...
|--------------------------------------|---------------------------------------------|
|[AreConvertible](template_meta_programming.md#SS_12_3_3_1)                 |クラステンプレートの特殊化                   |
|[ConvertibleToAll](template_meta_programming.md#SS_12_3_3_3)               |AreConvertibleをコンセプトへ                 |
|[AreConvertibleWithoutNarrowConv](template_meta_programming.md#SS_12_3_3_2)|SFINAEとクラステンプレートの特殊化           |
|[ConvertibleWithoutNarrowing](template_meta_programming.md#SS_12_3_3_4)    |AreConvertibleWithoutNarrowConvをコンセプトへ|


#### AreConvertible <a id="SS_12_3_3_1"></a>
...
「[IsSameSomeOf](template_meta_programming.md#SS_12_3_2_8)の実装」のコードパターンとほぼ同様であるため、解説は不要だろうが、
...
#### AreConvertibleWithoutNarrowConv <a id="SS_12_3_3_2"></a>
...
上記を抜粋した下記のコードは「縮小型変換を発生さる{}による初期化は[ill-formed](core_lang_spec.md#SS_18_14_1)になる」
ことをSFINAEに利用している。
...
#### ConvertibleToAll <a id="SS_12_3_3_3"></a>
...
#### ConvertibleWithoutNarrowing <a id="SS_12_3_3_4"></a>
ConvertibleWithoutNarrowingは以下のようなコンセプトである。

* [AreConvertibleWithoutNarrowConv](template_meta_programming.md#SS_12_3_3_2)と同様の機能を持つ
* [ConvertibleToAll](template_meta_programming.md#SS_12_3_3_3)と同様構造を持つ
...
|メタ関数名                              |メタ関数の目的                                    |
|----------------------------------------|--------------------------------------------------|
|[exists_void_func_sfinae_f](template_meta_programming.md#SS_12_3_4_1)        |メンバ関数void func()を持つかどうかの判断         |
|[exists_void_func_sfinae_s](template_meta_programming.md#SS_12_3_4_2)        |同上                                              |
|[exists_void_func_sfinae_s2](template_meta_programming.md#SS_12_3_4_3)       |同上                                              |
|[exists_void_func_concept](template_meta_programming.md#SS_12_3_4_4)         |同上。コンセプトによるSFINAEの回避                |
...
|メタ関数名                            |メタ関数の目的                                                     |
|--------------------------------------|-------------------------------------------------------------------|
|[exists_begin/exsits_end](template_meta_programming.md#SS_12_3_4_5)        |SFINAEを使用したstd::begin(T)/std::end(T)が存在するか否かの診断    |
|[Array](template_meta_programming.md#SS_12_3_4_7)                          |型が配列である制約を行うためのコンセプト                           |
|[Beginable/Endable](template_meta_programming.md#SS_12_3_4_8)              |[コンセプト](core_lang_spec.md#SS_18_11_3)を使用したexists_begin/exsits_endを単純化した例   |
|[IsRange](template_meta_programming.md#SS_12_3_4_6)                        |exists_begin/exsits_endを使し、範囲forのオペランドになれるか?の判断|
|[Ranged](template_meta_programming.md#SS_12_3_4_9)                         |機能はIsRangeと同一だが、[コンセプト](core_lang_spec.md#SS_18_11_3)を使用しSFINAEの回避     |
|[Container](template_meta_programming.md#SS_12_3_4_10)                      |Ranged且つ!Arrayをコンテナと便宜的に決めつける                     |
...
|メタ関数名                            |メタ関数の目的                                         |
|--------------------------------------|-------------------------------------------------------|
|[exists_put_to_as_member](template_meta_programming.md#SS_12_3_4_11)        |std::ostream::operator<<(T)が存在するか否かの診断      |
|[exists_put_to_as_non_member](template_meta_programming.md#SS_12_3_4_12)    |operator<<(std::ostream&, T)が存在するか否かの診断     |
|[ExistsPutTo](template_meta_programming.md#SS_12_3_4_13)                    |std::ostream& << Tができるかどうかの診断               |
|[Printable](template_meta_programming.md#SS_12_3_4_14)                      |std::ostream& << Tができるかどうか制約コンセプト       |
...
#### exists_void_func_sfinae_f <a id="SS_12_3_4_1"></a>
...
#### exists_void_func_sfinae_s <a id="SS_12_3_4_2"></a>
...
#### exists_void_func_sfinae_s2 <a id="SS_12_3_4_3"></a>
...
[演習-メンバ関数の存在の診断](exercise_q.md#SS_21_11_11)

#### exists_void_func_concept <a id="SS_12_3_4_4"></a>
[exists_void_func_sfinae_s](template_meta_programming.md#SS_12_3_4_2)や[exists_void_func_sfinae_s2](template_meta_programming.md#SS_12_3_4_3)
...
以下に示すように、C++20から導入された[コンセプト](core_lang_spec.md#SS_18_11_3)はこのような問題の軽減につながる。
...
#### exists_begin/exsits_end <a id="SS_12_3_4_5"></a>
「テンプレートパラメータTに対して、
std::begin(T)が存在するか否かの診断」をするexists_beginの実装は、
「[exists_void_func_sfinae_s](template_meta_programming.md#SS_12_3_4_2)」
...
* [ill-formed](core_lang_spec.md#SS_18_14_1)ならばill-formedになる
* [well-formed](core_lang_spec.md#SS_18_14_2)ならvoidを生成する
...
の戻り型が配列型の[rvalue](core_lang_spec.md#SS_18_7_1_2)である"int (&&) [3]"となり、
...
そのオブジェクトが[lvalue](core_lang_spec.md#SS_18_7_1_1)(この例ではint (&)[3])であれば、
...
[演習-範囲for文のオペランドになれるかどうかの診断](exercise_q.md#SS_21_11_12)

#### Array <a id="SS_12_3_4_7"></a>
...
#### Beginable/Endable <a id="SS_12_3_4_8"></a>
コンセプトを使用し、[exists_begin/exsits_end](template_meta_programming.md#SS_12_3_4_5)をリファクタリングした例を以下に示す。
...
すでにみたようにRangedは[exists_begin/exsits_end](template_meta_programming.md#SS_12_3_4_5)の醜いコードを使用しないことで、
Rangedの可読性はIsRangedに比べ格段に改善している。

#### Container <a id="SS_12_3_4_10"></a>
...
#### exists_put_to_as_member <a id="SS_12_3_4_11"></a>
...
「[exists_void_func_sfinae_f](template_meta_programming.md#SS_12_3_4_1)の実装」と同様のパターンを使用したので解説は不要だろう。
...
#### exists_put_to_as_non_member <a id="SS_12_3_4_12"></a>
...
「[exists_begin/exsits_end](template_meta_programming.md#SS_12_3_4_5)や[exists_put_to_as_member](template_meta_programming.md#SS_12_3_4_11)の実装」
で使用したパターンを混合しただけなので解説や単体テストは省略する。


#### ExistsPutTo <a id="SS_12_3_4_13"></a>
...
「[IsRange](template_meta_programming.md#SS_12_3_4_6)の実装」に影響されて、一旦このように実装したが、先に書いた通り、
...
#### Printable <a id="SS_12_3_4_14"></a>
これまでのパターンに従ってPrintableを以下のように作る。

* [SFINAE](core_lang_spec.md#SS_18_11_1)を利用した[ExistsPutTo](template_meta_programming.md#SS_12_3_4_13)は複雑で醜いため、リファクタリングする。
...
これ以降は、[ExistsPutTo](template_meta_programming.md#SS_12_3_4_13)ではなくPrintableを使用する。

#### ValueTypeの実装 <a id="SS_12_3_4_15"></a>
下記で示す通り、
...
この特殊化のテンプレートパラメータの制約にはすでに開発したコンセプト[Container](template_meta_programming.md#SS_12_3_4_10)を使用する。
...
[演習-配列の長さの取り出し](exercise_q.md#SS_21_11_13)
[演習-配列の次元の取り出し](exercise_q.md#SS_21_11_14)

## Nstdライブラリの開発2 <a id="SS_12_4"></a>
ここでは予定していた通りSafeArray2を開発し、その後Nstdに必要なライブラリの開発を続ける。


### SafeArray2の開発 <a id="SS_12_4_1"></a>
「[安全な配列型コンテナ](template_meta_programming.md#SS_12_2_3)」で断念したSafeArray2の開発を再開する前に、
SafeArray2の要件をまとめると、
...
縮小型変換が起こるか否かの場合分けは、
コンセプト[ConvertibleWithoutNarrowing](template_meta_programming.md#SS_12_3_3_4)を使用したSFINAEで実現させることができる。
...
このような記述が必要になる。
一方で[コンセプト](core_lang_spec.md#SS_18_11_3)を使用したC++20スタイルのSFINAEの可読性の高さを実感できただろう。
...
### Nstd::SafeIndexの開発 <a id="SS_12_4_2"></a>
「[安全なvector](template_meta_programming.md#SS_12_2_2)」、「[安全な配列型コンテナ](template_meta_programming.md#SS_12_2_3)」等の中で、
...
(「[is_same_templ](template_meta_programming.md#SS_12_3_2_7)」参照)を使用し下記のように書ける。
...
値を型に変換する[std::integral_constant](stdlib_and_concepts.md#SS_19_2_1)を使用し、この問題を解決できる。
...
### Nstd::SafeIndexのoperator\<\<の開発 <a id="SS_12_4_3"></a>
...
「[メタ関数のテクニック](template_meta_programming.md#SS_12_3)」で紹介したSFINAEによりこの問題を回避できるが、
ここでも、すでにみてきた[コンセプト](core_lang_spec.md#SS_18_11_3)による制約によりこの問題に対処する。
...
### コンテナ用Nstd::operator\<\<の開発 <a id="SS_12_4_4"></a>
「[Nstd::SafeIndexのoperator\<\<の開発](template_meta_programming.md#SS_12_4_3)」で定義したNstd::operator\<\<の構造は、
...
実際、現在使用中の[g++](cpp_idioms.md#SS_20_12_1)ではこのコードはコンパイルできず、
...
## Nstdライブラリの開発3(浮動小数点関連) <a id="SS_12_5"></a>
[浮動小数点型](core_lang_spec.md#SS_18_1_12)を頻繁に使用するソフトウェアの開発を行うに場合、
ソースコードの中で、場当たり的に浮動小数点型を使用すると、
[浮動小数点の誤差](core_lang_spec.md#SS_18_1_12_2)や[浮動小数点の演算エラー](core_lang_spec.md#SS_18_1_12_4)
にまつわるバグの修正に多くの工数をロスしてしまうことになる。

これらの課題に対処するため、この節は浮動小数点演算によるバグを未然に防ぎ、
精度を確保するための機能を提供することを目的としている。
[浮動小数点の比較](template_meta_programming.md#SS_12_5_1)方法や、
浮動小数点を避けて高精度な演算を実現する[固定小数点クラス](template_meta_programming.md#SS_12_5_2)および[有理数クラス](template_meta_programming.md#SS_12_5_4)を導入し、
さらにそれらを簡単に使用できるリテラル表記もサポートしている。

### 浮動小数点の比較 <a id="SS_12_5_1"></a>
...
### 固定小数点リテラル <a id="SS_12_5_3"></a>
[固定小数点クラス](template_meta_programming.md#SS_12_5_2)のようなクラス定義には、以下に示すようにユーザ定義リテラルを定義し、
...
### 有理数クラス <a id="SS_12_5_4"></a>
[固定小数点クラス](template_meta_programming.md#SS_12_5_2)では精度が足りず、浮動小数点を使用したくない場合、
...
### 有理数リテラル <a id="SS_12_5_5"></a>
[固定小数点クラス](template_meta_programming.md#SS_12_5_2)に対して、[固定小数点リテラル](template_meta_programming.md#SS_12_5_3)を定義したように、
使い勝手のよい環境をユーザに提供するために、
[有理数クラス](template_meta_programming.md#SS_12_5_4)に対して、有理数リテラルを定義するべきである。
...
それは 「[コンテナ用Nstd::operator\<\<の開発](template_meta_programming.md#SS_12_4_4)」で示したコードそのものであるため、
...
「[Nstdライブラリの開発](template_meta_programming.md#SS_12_2)」で示した依存関係も維持されており、
これでログ取得ライブラリは完成したと言って良いだろう。


## その他のテンプレートテクニック <a id="SS_12_7"></a>
ここでは、これまでの議論の対象にならなかったテンプレートのテクニックや注意点について記述する。

### forwardingリファレンスとstd::forward <a id="SS_12_7_1"></a>
...
[forwardingリファレンス](core_lang_spec.md#SS_18_8_3)を使って下記のように書き直した。
...
その関数から別の関数に受け渡される時に[lvalue](core_lang_spec.md#SS_18_7_1_1)リファレンスとして扱われる」からである。
...
[畳み込み式](core_lang_spec.md#SS_18_11_5)を使用した下記の実装の方がより明確である。
...
(T const&&はconstな[rvalue](core_lang_spec.md#SS_18_7_1_2)リファレンスである)、
forwardingリファレンスが[lvalue](core_lang_spec.md#SS_18_7_1_1)リファレンスであった場合は、
...
なお、forwardingリファレンスは、[リファレンスcollapsing](core_lang_spec.md#SS_18_8_6)の一機能としても理解できる。

### ジェネリックラムダによる関数内での関数テンプレートの定義 <a id="SS_12_7_2"></a>
...
「[Nstd::SafeIndexの開発](template_meta_programming.md#SS_12_4_2)」や「[コンテナ用Nstd::operator\<\<の開発](template_meta_programming.md#SS_12_4_4)」
...
この記法は[ジェネリックラムダ](core_lang_spec.md#SS_18_11_6)と呼ばれる。
この機能により関数の中で関数テンプレートと同等のものが定義できるようになった。

#### ジェネリックラムダの内部構造 <a id="SS_12_7_2_1"></a>
...
#### std::variantとジェネリックラムダ <a id="SS_12_7_2_2"></a>
...
ここで示した関数テンプレートは、デザインパターン[Visitor](appendix.md#SS_25_1_11)の例であり、
...
### クラステンプレートと継承の再帰構造 <a id="SS_12_7_3"></a>
クラステンプレートと継承の再帰構造はCRTPと呼ばれる。
このコードパターンについては、
「[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_20_1_4)」で説明している。


### 意図しないname lookupの防止 <a id="SS_12_7_4"></a>
...
[ADL](core_lang_spec.md#SS_18_12_5)(実引数依存探索)により、Appもis_equalの[name lookup](core_lang_spec.md#SS_18_12_2)の対象になるからである。
...
* [ジェネリックすぎるテンプレートを書かない](template_meta_programming.md#SS_12_7_4_1)
* [ADLが本当に必要でない限り名前を修飾する](template_meta_programming.md#SS_12_7_4_2)
* [ADL Firewallを使う](template_meta_programming.md#SS_12_7_4_3)

のようにいくつか考えられる。これらについて以下で説明を行う。

#### ジェネリックすぎるテンプレートを書かない <a id="SS_12_7_4_1"></a>
...
[ジェネリックラムダによる関数内での関数テンプレートの定義](template_meta_programming.md#SS_12_7_2)を行えばよい。
...
といった方法の他にも、「[コンテナ用Nstd::operator\<\<の開発](template_meta_programming.md#SS_12_4_4)」で示した

* [std::enable_if](stdlib_and_concepts.md#SS_19_2_5)や[コンセプト](core_lang_spec.md#SS_18_11_3)等を使用してテンプレートに適用できる型を制約する
...
#### ADLが本当に必要でない限り名前を修飾する <a id="SS_12_7_4_2"></a>
下記のコードについて考える。
...
([two phase name lookup](core_lang_spec.md#SS_18_12_3)の一回目のname lookupでfがバインドされるため)。
...
[ADL](core_lang_spec.md#SS_18_12_5)や[two phase name lookup](core_lang_spec.md#SS_18_12_3)が絡む場合ならなおさらである。

こういう意図しない[name lookup](core_lang_spec.md#SS_18_12_2)に備えるためには、
修飾されていない識別子を使わないこと、つまり、
識別子には、名前空間、クラス名、this->等による修飾を施すことが重要である。

ただし、「[コンテナ用Nstd::operator\<\<の開発](template_meta_programming.md#SS_12_4_4)」で示したコード等にはADLが欠かせないため、
修飾することをルール化することはできない。場合に合わせた運用が唯一の解となる。


#### ADL Firewallを使う <a id="SS_12_7_4_3"></a>
下記のコードについて考える。
...
上記のApp::ToStringは「[コンテナ用Nstd::operator\<\<の開発](template_meta_programming.md#SS_12_4_4)」のコードを使用し、
...
XY型オブジェクトを引数にした関数呼び出しによる[関連名前空間](core_lang_spec.md#SS_18_12_6)は、
...
### Nstd::Type2Strの開発 <a id="SS_12_7_5"></a>
「[Nstdライブラリの開発](template_meta_programming.md#SS_12_2)」等で行ったメタ関数の実装は、
...
等によるコンパイルエラーとの戦いである。
また、これをクリアしても[two phase name lookup](core_lang_spec.md#SS_18_12_3)や[ADL](core_lang_spec.md#SS_18_12_5)が次の関門になる。
これには、デバッガのステップ実行が強力な武器となるが、
型を文字列に変換する関数があればこれもまた強力な武器となる。

以下に示すNstd::Type2Strは、「[Nstdライブラリの開発](template_meta_programming.md#SS_12_2)」等で実際に使用したそのような関数である。
...
残念なことにこの関数は非標準であるため、
それを使っているNstd::Inner\_::demangleは[g++](cpp_idioms.md#SS_20_12_1)/[clang++](cpp_idioms.md#SS_20_12_2)
でなければコンパイルできないだろう。
...
#### StaticStringのヘルパークラスの開発 <a id="SS_12_7_6_1"></a>
...
#### StaticStringの開発 <a id="SS_12_7_6_2"></a>
...
[暗黙の型変換](core_lang_spec.md#SS_18_6_2_2)を利用した文字列リテラルからStaticStringオブジェクトへの変換は、
...
#### 整数をStaticStringに変換する関数の開発 <a id="SS_12_7_6_3"></a>
...
#### ファイル位置を静的に保持したエクセプションクラスの開発 <a id="SS_12_7_6_4"></a>
「[静的な文字列オブジェクト](template_meta_programming.md#SS_12_7_6)」で見たように、
...
### 関数型をテンプレートパラメータで使う <a id="SS_12_7_7"></a>
ここで使う「関数型」とは、
...
「[RAII(scoped guard)](cpp_idioms.md#SS_20_1_2)でも示したScopedGuardの実装を下記する。
...
[演習-関数型のテンプレートパラメータを持つクラステンプレート](exercise_q.md#SS_21_11_15)  

## 注意点まとめ <a id="SS_12_8"></a>
本章では、テンプレートメタプログラミングのテクニックや注意点について解説したが、
本章の情報量は多く、また他の章で行ったものもあるため以下にそれらをまとめる。

* [name lookup](core_lang_spec.md#SS_18_12_2)には複雑なルールが適用されるため、非直感的なバインドが行われる場合がある。
  従って、テンプレートライブラリの開発には単体テストは必須である。

* 使用しているコンパイラが[two phase name lookup](core_lang_spec.md#SS_18_12_3)をサポートしているか否かに気を付ける。
...
* 可変長引数を持つ関数の実装には[パラメータパック](core_lang_spec.md#SS_18_11_4)を使う。

* 処理速度や関数のリターンの型に影響する場合があるため、
  パラメータパックの処理の順番に気を付ける(「[前から演算するパラメータパック](template_meta_programming.md#SS_12_1_3_2)」参照)。

* [ADL](core_lang_spec.md#SS_18_12_5)を利用しない場合、テンプレートで使う識別子は名前空間名やthis->等で修飾する
  (「[意図しないname lookupの防止](template_meta_programming.md#SS_12_7_4)」参照)。
...
* テンプレートのインターフェースではないが、実装の都合上ヘッダファイルに記述する定義は、
  ...
  外部から参照しない(「[is_void_sfinae_f](template_meta_programming.md#SS_12_3_1_3)の実装」参照)。

* [forwardingリファレンス](core_lang_spec.md#SS_18_8_3)の実際の型がlvalueリファレンスであるならば、
  constなlvalueリファレンスとして扱う
  。

* ユニバーサルリファレンス引数を他の関数に渡すのであれば、std::forwardを使う
  (「[forwardingリファレンス](core_lang_spec.md#SS_18_8_3)」、「[forwardingリファレンスとstd::forward](template_meta_programming.md#SS_12_7_1)」参照)。

* 関数テンプレートとその特殊化はソースコード上なるべく近い位置で定義する
  (「[two phase name lookup](core_lang_spec.md#SS_18_12_3)」参照)。

* [two phase name lookup](core_lang_spec.md#SS_18_12_3)により意図しない副作用が発生する可能性があるため、
...
* 関数テンプレートのオーバーロードと特殊化の[name lookup](core_lang_spec.md#SS_18_12_2)の優先度に気を付ける。
...
* forwardingリファレンスを持つ関数テンプレートをオーバーロードしない。
  「[forwardingリファレンスとstd::forward](template_meta_programming.md#SS_12_7_1)」で述べたように、
...
* テンプレートに関数型オブジェクトを渡す場合、リファレンスの付け忘れに気を付ける
  (「[関数型をテンプレートパラメータで使う](template_meta_programming.md#SS_12_7_7)」
  、「[現象6 - STLのバグ?](debug.md#SS_14_9_6)」
  参照)。

* 意図しないテンプレートパラメータによるインスタンス化の防止や、
  コンパイルエラーを解読しやすくするために、適切にstatic_assert使うことは重要であるが、
  static_assertによるテンプレートパラメータの制約よりも、[コンセプト](core_lang_spec.md#SS_18_11_3)による制約を優先する。

* ランタイム時の処理を削減する、static_assertを適切に用いる等の目的のために、
  関数テンプレートには適切にconstexprを付けて宣言する
  (「[コンテナ用Nstd::operator\<\<の開発](template_meta_programming.md#SS_12_4_4)」
  参照)。
