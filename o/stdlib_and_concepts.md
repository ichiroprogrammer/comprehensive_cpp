<!-- deep/md/stdlib_and_concepts.md -->
...
&emsp;&emsp; [コンテナ](stdlib_and_concepts.md#SS_20_6)  
&emsp;&emsp;&emsp; [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_20_6_1)  
&emsp;&emsp;&emsp;&emsp; [std::forward_list](stdlib_and_concepts.md#SS_20_6_1_1)  

&emsp;&emsp;&emsp; [連想コンテナ(Associative Containers)](stdlib_and_concepts.md#SS_20_6_2)  
&emsp;&emsp;&emsp; [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_20_6_3)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_set](stdlib_and_concepts.md#SS_20_6_3_1)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_map](stdlib_and_concepts.md#SS_20_6_3_2)  
&emsp;&emsp;&emsp;&emsp; [std::type_index](stdlib_and_concepts.md#SS_20_6_3_3)  

&emsp;&emsp;&emsp; [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_20_6_4)  
&emsp;&emsp;&emsp; [特殊なコンテナ](stdlib_and_concepts.md#SS_20_6_5)  

&emsp;&emsp; [std::optional](stdlib_and_concepts.md#SS_20_7)  
&emsp;&emsp;&emsp; [戻り値の無効表現](stdlib_and_concepts.md#SS_20_7_1)  
&emsp;&emsp;&emsp; [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_20_7_2)  

&emsp;&emsp; [std::variant](stdlib_and_concepts.md#SS_20_8)  
&emsp;&emsp; [オブジェクトの比較](stdlib_and_concepts.md#SS_20_9)  
&emsp;&emsp;&emsp; [std::rel_ops](stdlib_and_concepts.md#SS_20_9_1)  
&emsp;&emsp;&emsp; [std::tuppleを使用した比較演算子の実装方法](stdlib_and_concepts.md#SS_20_9_2)  

&emsp;&emsp; [その他](stdlib_and_concepts.md#SS_20_10)  
&emsp;&emsp;&emsp; [SSO(Small String Optimization)](stdlib_and_concepts.md#SS_20_10_1)  
&emsp;&emsp;&emsp; [heap allocation elision](stdlib_and_concepts.md#SS_20_10_2)  
...
一般に条件変数には、[Spurious Wakeup](cpp_idioms.md#SS_21_8_5)という問題があり、std::condition_variableも同様である。

上記の抜粋である下記のコード例では[Spurious Wakeup](cpp_idioms.md#SS_21_8_5)の対策が行われていないため、
意図通り動作しない可能性がある。
...
* [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_20_6_1)
* [連想コンテナ(Associative Containers)(---)
* [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_20_6_3)
* [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_20_6_4)
* [特殊なコンテナ](stdlib_and_concepts.md#SS_20_6_5)

### シーケンスコンテナ(Sequence Containers) <a id="SS_20_6_1"></a>
...
| [std::forward_list](stdlib_and_concepts.md#SS_20_6_1_1) | 単方向リスト。軽量だが、双方向の操作はできない                      |
| `std::array`             | 固定長配列で、サイズがコンパイル時に決まる                          |
| `std::string`            | 可変長の文字列を管理するクラス(厳密には`std::basic_string`の特殊化) |

#### std::forward_list <a id="SS_20_6_1_1"></a>
...
### 連想コンテナ(Associative Containers) <a id="SS_20_6_2"></a>
...
### 無順序連想コンテナ(Unordered Associative Containers) <a id="SS_20_6_3"></a>
ハッシュテーブルを基盤としたコンテナで、順序を保証しないが高速な検索を提供する。

| コンテナ                  | 説明                                                   |
|---------------------------|--------------------------------------------------------|
| [std::unordered_set](stdlib_and_concepts.md#SS_20_6_3_1) | ハッシュテーブルベースの集合。重複は許されない         |
| `std::unordered_multiset` | ハッシュテーブルベースの集合。重複が許される           |
| [std::unordered_map](stdlib_and_concepts.md#SS_20_6_3_2) | ハッシュテーブルベースのキーと値のペア。キーは一意     |
...
#### std::unordered_set <a id="SS_20_6_3_1"></a>
...
#### std::unordered_map <a id="SS_20_6_3_2"></a>
...
#### std::type_index <a id="SS_20_6_3_3"></a>
...
### コンテナアダプタ(Container Adapters) <a id="SS_20_6_4"></a>
...
1. 関数の任意の型の[戻り値の無効表現](stdlib_and_concepts.md#SS_20_7_1)を持たせる
2. [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_20_7_2)する(初期化処理が重く、
   条件によってはそれが無駄になる場合にこの機能を使う)

### 戻り値の無効表現 <a id="SS_20_7_1"></a>
```cpp
...
## オブジェクトの比較 <a id="SS_20_9"></a>
### std::rel_ops <a id="SS_20_9_1"></a>
...
### std::tuppleを使用した比較演算子の実装方法 <a id="SS_20_9_2"></a>
...
## その他 <a id="SS_20_10"></a>
### SSO(Small String Optimization) <a id="SS_20_10_1"></a>
...
### heap allocation elision <a id="SS_20_10_2"></a>
