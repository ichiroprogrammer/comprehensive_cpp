...
2.1 [型とインスタンス](programming_convention.md#SS_2_1)  
&emsp;2.1.1 [算術型](programming_convention.md#SS_2_1_1)  
&emsp;&emsp;2.1.1.1 [整数型](programming_convention.md#SS_2_1_1_1)  
&emsp;&emsp;2.1.1.2 [char型](programming_convention.md#SS_2_1_1_2)  
&emsp;&emsp;2.1.1.3 [std::byte型](programming_convention.md#SS_2_1_1_3)  
&emsp;&emsp;2.1.1.4 [bool型](programming_convention.md#SS_2_1_1_4)  
&emsp;&emsp;2.1.1.5 [浮動小数点型](programming_convention.md#SS_2_1_1_5)  

&emsp;2.1.2 [enum](programming_convention.md#SS_2_1_2)  
&emsp;2.1.3 [bit field](programming_convention.md#SS_2_1_3)  
&emsp;2.1.4 [class](programming_convention.md#SS_2_1_4)  
&emsp;2.1.5 [struct](programming_convention.md#SS_2_1_5)  
&emsp;2.1.6 [union](programming_convention.md#SS_2_1_6)  
&emsp;2.1.7 [配列](programming_convention.md#SS_2_1_7)  
&emsp;2.1.8 [型エイリアス](programming_convention.md#SS_2_1_8)  
&emsp;2.1.9 [const/constexprインスタンス](programming_convention.md#SS_2_1_9)  
&emsp;2.1.10 [リテラル](programming_convention.md#SS_2_1_10)  
&emsp;&emsp;2.1.10.1 [生文字列リテラル](programming_convention.md#SS_2_1_10_1)  

&emsp;2.1.11 [型推論](programming_convention.md#SS_2_1_11)  
&emsp;&emsp;2.1.11.1 [auto](programming_convention.md#SS_2_1_11_1)  

&emsp;2.1.12 [インスタンスの初期化](programming_convention.md#SS_2_1_12)  
&emsp;2.1.13 [rvalue](programming_convention.md#SS_2_1_13)  

2.2 [クラスとオブジェクト](programming_convention.md#SS_2_2)  
&emsp;2.2.1 [ファイルの使用方法](programming_convention.md#SS_2_2_1)  
&emsp;2.2.2 [クラスの規模](programming_convention.md#SS_2_2_2)  
&emsp;&emsp;2.2.2.1 [行数](programming_convention.md#SS_2_2_2_1)  
&emsp;&emsp;2.2.2.2 [メンバの数](programming_convention.md#SS_2_2_2_2)  
&emsp;&emsp;2.2.2.3 [凝集性](programming_convention.md#SS_2_2_2_3)  

&emsp;2.2.3 [アクセスレベルと隠蔽化](programming_convention.md#SS_2_2_3)  
&emsp;2.2.4 [メンバ関数](programming_convention.md#SS_2_2_4)  
&emsp;&emsp;2.2.4.1 [特殊メンバ関数](programming_convention.md#SS_2_2_4_1)  
&emsp;&emsp;2.2.4.2 [コンストラクタ](programming_convention.md#SS_2_2_4_2)  
&emsp;&emsp;2.2.4.3 [copyコンストラクタ、copy代入演算子](programming_convention.md#SS_2_2_4_3)  
&emsp;&emsp;2.2.4.4 [moveコンストラクタ、move代入演算子](programming_convention.md#SS_2_2_4_4)  
&emsp;&emsp;2.2.4.5 [初期化子リストコンストラクタ](programming_convention.md#SS_2_2_4_5)  
&emsp;&emsp;2.2.4.6 [デストラクタ](programming_convention.md#SS_2_2_4_6)  
&emsp;&emsp;2.2.4.7 [オーバーライド](programming_convention.md#SS_2_2_4_7)  

&emsp;2.2.5 [メンバ変数](programming_convention.md#SS_2_2_5)  
&emsp;&emsp;2.2.5.1 [メンバ変数の数 ](programming_convention.md#SS_2_2_5_1)  
&emsp;&emsp;2.2.5.2 [非静的なメンバ変数](programming_convention.md#SS_2_2_5_2)  
&emsp;&emsp;2.2.5.3 [静的なメンバ変数/定数の初期化](programming_convention.md#SS_2_2_5_3)  
&emsp;&emsp;2.2.5.4 [mutableなメンバ変数](programming_convention.md#SS_2_2_5_4)  

&emsp;2.2.6 [継承/派生](programming_convention.md#SS_2_2_6)  
&emsp;&emsp;2.2.6.1 [インターフェースの継承](programming_convention.md#SS_2_2_6_1)  
&emsp;&emsp;2.2.6.2 [多重継承](programming_convention.md#SS_2_2_6_2)  

&emsp;2.2.7 [オブジェクト](programming_convention.md#SS_2_2_7)  
&emsp;&emsp;2.2.7.1 [スライシング](programming_convention.md#SS_2_2_7_1)  
&emsp;&emsp;2.2.7.2 [オブジェクトの所有権](programming_convention.md#SS_2_2_7_2)  
&emsp;&emsp;2.2.7.3 [オブジェクトのライフタイム](programming_convention.md#SS_2_2_7_3)  

2.3 [関数](programming_convention.md#SS_2_3)  
&emsp;2.3.1 [関数構造のクライテリア](programming_convention.md#SS_2_3_1)  
&emsp;2.3.2 [オーバーロード](programming_convention.md#SS_2_3_2)  
&emsp;2.3.3 [演算子オーバーロード](programming_convention.md#SS_2_3_3)  
&emsp;2.3.4 [実引数/仮引数](programming_convention.md#SS_2_3_4)  
&emsp;2.3.5 [自動変数](programming_convention.md#SS_2_3_5)  
&emsp;2.3.6 [戻り値型](programming_convention.md#SS_2_3_6)  
&emsp;2.3.7 [constexpr関数](programming_convention.md#SS_2_3_7)  
&emsp;2.3.8 [スレッドセーフ性](programming_convention.md#SS_2_3_8)  
&emsp;2.3.9 [エクセプション処理](programming_convention.md#SS_2_3_9)  
&emsp;2.3.10 [ビジーループ](programming_convention.md#SS_2_3_10)  
&emsp;2.3.11 [非メンバ関数](programming_convention.md#SS_2_3_11)  

2.4 [構文](programming_convention.md#SS_2_4)  
&emsp;2.4.1 [複合文](programming_convention.md#SS_2_4_1)  
&emsp;2.4.2 [switch文](programming_convention.md#SS_2_4_2)  
&emsp;2.4.3 [if文](programming_convention.md#SS_2_4_3)  
&emsp;2.4.4 [while文](programming_convention.md#SS_2_4_4)  
&emsp;2.4.5 [範囲for文](programming_convention.md#SS_2_4_5)  
&emsp;2.4.6 [制御文のネスト](programming_convention.md#SS_2_4_6)  
&emsp;2.4.7 [return文](programming_convention.md#SS_2_4_7)  
&emsp;2.4.8 [goto文](programming_convention.md#SS_2_4_8)  
&emsp;2.4.9 [ラムダ式](programming_convention.md#SS_2_4_9)  
&emsp;2.4.10 [マクロの中の文](programming_convention.md#SS_2_4_10)  

2.5 [演算子](programming_convention.md#SS_2_5)  
&emsp;2.5.1 [優先順位](programming_convention.md#SS_2_5_1)  
&emsp;2.5.2 [代入演算](programming_convention.md#SS_2_5_2)  
&emsp;2.5.3 [ビット演算](programming_convention.md#SS_2_5_3)  
&emsp;2.5.4 [論理演算](programming_convention.md#SS_2_5_4)  
&emsp;2.5.5 [条件演算子](programming_convention.md#SS_2_5_5)  
&emsp;2.5.6 [メモリアロケーション](programming_convention.md#SS_2_5_6)  
&emsp;&emsp;2.5.6.1 [new](programming_convention.md#SS_2_5_6_1)  
&emsp;&emsp;2.5.6.2 [delete](programming_convention.md#SS_2_5_6_2)  

&emsp;2.5.7 [sizeof](programming_convention.md#SS_2_5_7)  
&emsp;2.5.8 [ポインタ間の演算](programming_convention.md#SS_2_5_8)  
&emsp;2.5.9 [RTTI](programming_convention.md#SS_2_5_9)  
&emsp;2.5.10 [キャスト、暗黙の型変換](programming_convention.md#SS_2_5_10)  

2.6 [プリプロセッサ命令](programming_convention.md#SS_2_6)  
&emsp;2.6.1 [関数型マクロ](programming_convention.md#SS_2_6_1)  
&emsp;2.6.2 [マクロ定数](programming_convention.md#SS_2_6_2)  

2.7 [ソースコードファイルとディレクトリ](programming_convention.md#SS_2_7)  
&emsp;2.7.1 [識別子の宣言、定義](programming_convention.md#SS_2_7_1)  
&emsp;2.7.2 [依存関係](programming_convention.md#SS_2_7_2)  
&emsp;2.7.3 [二重読み込みの防御](programming_convention.md#SS_2_7_3)  
&emsp;2.7.4 [ヘッダファイル内の#include](programming_convention.md#SS_2_7_4)  
&emsp;2.7.5 [#includeするファイルの順番](programming_convention.md#SS_2_7_5)  
&emsp;2.7.6 [#includeで指定するパス名](programming_convention.md#SS_2_7_6)  

2.8 [スコープ](programming_convention.md#SS_2_8)  
&emsp;2.8.1 [スコープの定義と原則](programming_convention.md#SS_2_8_1)  
&emsp;2.8.2 [名前空間](programming_convention.md#SS_2_8_2)  
&emsp;2.8.3 [using宣言/usingディレクティブ](programming_convention.md#SS_2_8_3)  
&emsp;2.8.4 [ADLと名前空間による修飾の省略](programming_convention.md#SS_2_8_4)  
&emsp;2.8.5 [名前空間のエイリアス](programming_convention.md#SS_2_8_5)  

2.9 [ランタイムの効率](programming_convention.md#SS_2_9)  
&emsp;2.9.1 [前置/後置演算子の選択](programming_convention.md#SS_2_9_1)  
&emsp;2.9.2 [operator X、operator x=の選択](programming_convention.md#SS_2_9_2)  
&emsp;2.9.3 [関数の戻り値オブジェクト](programming_convention.md#SS_2_9_3)  
&emsp;2.9.4 [move処理](programming_convention.md#SS_2_9_4)  
&emsp;2.9.5 [std::string vs std::string const& vs std::string_view](programming_convention.md#SS_2_9_5)  
&emsp;2.9.6 [extern template](programming_convention.md#SS_2_9_6)  

2.10 [標準クラス、関数の使用制限](programming_convention.md#SS_2_10)  
&emsp;2.10.1 [標準ライブラリ](programming_convention.md#SS_2_10_1)  
&emsp;&emsp;2.10.1.1 [スマートポインタの使用制限](programming_convention.md#SS_2_10_1_1)  
&emsp;&emsp;2.10.1.2 [配列系コンテナクラスの使用制限](programming_convention.md#SS_2_10_1_2)  
&emsp;&emsp;2.10.1.3 [std::stringの使用制限](programming_convention.md#SS_2_10_1_3)  
&emsp;&emsp;2.10.1.4 [std::string_viewの使用制限](programming_convention.md#SS_2_10_1_4)  

&emsp;2.10.2 [POSIX系関数](programming_convention.md#SS_2_10_2)  
&emsp;&emsp;2.10.2.1 [使用禁止関数一覧](programming_convention.md#SS_2_10_2_1)  
&emsp;&emsp;2.10.2.2 [使用禁止関数の理由や注意点](programming_convention.md#SS_2_10_2_2)  
&emsp;&emsp;2.10.2.3 [典型的な注意点](programming_convention.md#SS_2_10_2_3)  

2.11 [その他](programming_convention.md#SS_2_11)  
&emsp;2.11.1 [assertion](programming_convention.md#SS_2_11_1)  
&emsp;2.11.2 [アセンブラ](programming_convention.md#SS_2_11_2)  
&emsp;2.11.3 [言語拡張機能](programming_convention.md#SS_2_11_3)  

2.12 [特に重要なプログラミング規約](programming_convention.md#SS_2_12)  
...
## 2.1 型とインスタンス <a id="SS_2_1"></a>

### 2.1.1 算術型 <a id="SS_2_1_1"></a>

#### 2.1.1.1 整数型 <a id="SS_2_1_1_1"></a>
* [整数型](core_lang_spec.md#SS_15_1_5)には、整数の基本型(intやlong等)を直接使わずに、
...
* [演習-汎整数型の選択](exercise_q.md#SS_18_1_1)

#### 2.1.1.2 char型 <a id="SS_2_1_1_2"></a>
* charはascii文字の保持のみに使用する。
* char\*をvoid\*の代わりに使わない。
* charがsingedかunsignedかは処理系に依存するため、char型を[汎整数型](core_lang_spec.md#SS_15_1_4)として扱わない。
  8ビット整数には、int8\_tまたは、uint8\_tを使用する。
    * バイトストリームを表現する場合、int8_t\*、int8_t[]、uint8_t\*、uint8_t[]のいずれかを使う。

* [演習-汎整数型の演算](exercise_q.md#SS_18_1_2)

#### 2.1.1.3 std::byte型 <a id="SS_2_1_1_3"></a>
* intよりもビット幅の小さい組み込み型の演算の結果は[汎整数型拡張](core_lang_spec.md#SS_15_1_8)によりint型になるため、
  uint8_tのビット演算の型もintとなる。
  intへの拡張が意図したものかどうかの判別は困難であるため、
  uint8_tインスタンスにビット演算が必要な場合、
  uint8_tの代わりに下記のようにstd::byte(「[BitmaskType](cpp_idioms.md#SS_17_2_3)」参照)を用いる。
...
#### 2.1.1.4 bool型 <a id="SS_2_1_1_4"></a>
* bool型は、bool型リテラル(true/false)やbool型オブジェクトの保持のみに使用する。
* bool型を[汎整数型](core_lang_spec.md#SS_15_1_4)として扱わない。bool型に++を使用しない(--はコンパイルできない)。
...
#### 2.1.1.5 浮動小数点型 <a id="SS_2_1_1_5"></a>
* 小数演算に安易に[浮動小数点型](core_lang_spec.md#SS_15_1_12)を使用せず、
  [浮動小数点型のダイナミックレンジ](core_lang_spec.md#SS_15_1_12_1)が必要な場合のみにこれらの型を使用する。
  ちなみに銀河系の直径は1e+21メートル程度、プランク長は1.616229e-35メートルであるため、
  銀河から素粒子までのサイズを一つの基本型で表す場合においても、
  floatのダイナミックレンジに収まる。
  従って、floatやdoubleが必要になる場合は極めて限られる。

* [浮動小数点の誤差](core_lang_spec.md#SS_15_1_12_2)は避けられないため、浮動小数点型のインスタンスを==、!=で比較しない。
  代わりに[浮動小数点の比較](template_meta_programming.md#SS_12_5_1)で定義した関数テンプレートを使用する。
...
* 一つの式にfloatとdoubleを混在してしまうと、
  [イプシロン](core_lang_spec.md#SS_15_1_12_3)を使用した比較の定義ができなくなるので、
...
* INFや、NANを演算で使用しない(「[浮動小数点の演算エラー](core_lang_spec.md#SS_15_1_12_4)」参照)。
* [汎整数型](core_lang_spec.md#SS_15_1_4)の演算とは違い、0除算等の[浮動小数点の演算エラー](core_lang_spec.md#SS_15_1_12_4)は、
...
* 扱うダイナミックレンジに収まる限り、安易に浮動小数点を使わず、
  代わりに[固定小数点クラス](template_meta_programming.md#SS_12_5_2)や[有理数クラス](template_meta_programming.md#SS_12_5_4)を使用する。

* [演習-浮動小数点型](exercise_q.md#SS_18_1_3)

### 2.1.2 enum <a id="SS_2_1_2"></a>
* C++の強力な型システムや、コンパイラの静的解析機能(switchでのcase抜け)を効果的に使用するために、
  一連の定数の列挙にはenumを使用する。
* 使用範囲や方法が明示しづらく、且つ整数型への[算術変換](core_lang_spec.md#SS_15_1_6)が行われてしまう旧来のenum
...
* アプリケーションの設定ファイルに保存された情報を復元させるような場合や、
  「[BitmaskType](cpp_idioms.md#SS_17_2_3)」を使用する場合を除き、enumへのキャストをしない。
* クラスのstatic constの整数定数の代わりにenumを使うことは、
  C++言語仕様やコンパイラの機能が不十分だった頃のテクニックであり、もはや不要である。
  代わりにstatic constexprインスタンス(「[constexpr関数](core_lang_spec.md#SS_15_5_3)」参照)を使用する。
  こうすることで定数の型を明示できる。

* [演習-定数列挙](exercise_q.md#SS_18_1_4)
* [演習-enum](exercise_q.md#SS_18_1_5)

### 2.1.3 bit field <a id="SS_2_1_3"></a>
* ハードウエアレジスタにアクセスをする目的でのみ使用する。
* bit fieldの型は、unsigned intにする。

### 2.1.4 class <a id="SS_2_1_4"></a>
* 「[クラスとオブジェクト](programming_convention.md#SS_2_2)」を参照せよ。

### 2.1.5 struct <a id="SS_2_1_5"></a>
* メンバ変数を持つ構造体は、[POD](core_lang_spec.md#SS_15_4_5)としてのみ使用する。
...
* メンバ変数(static constやstatic constexprメンバは定数とする)を持たない構造体は、
  ...
  (「[enum](programming_convention.md#SS_2_1_2)」や「[enum](core_lang_spec.md#SS_15_3_1)」参照)等に使用しても良い。
* コンストラクタ以外のメンバ関数を定義しない。
    * [ディープコピー](cpp_idioms.md#SS_17_12_2)(「[コンストラクタ](programming_convention.md#SS_2_2_4_2)」参照)が必要な型は、structでなくclassで表す。
    * デフォルトコンストラクタを除く[特殊メンバ関数](core_lang_spec.md#SS_15_6_1)に対して、
      = defaultの明示をしない。
...
* 上記のようなunionはランタイム依存性が強いため、それへの依存を最小にする。
  従って、unionの定義を外部[パッケージ](cpp_idioms.md#SS_17_9_2)に公開(「[ソースコードファイルとディレクトリ](programming_convention.md#SS_2_7)」参照)しない。

* 上記以外でunionのような機能が必要な場合、
  [std::variant](stdlib_and_concepts.md#SS_16_10)(「[std::variantとジェネリックラムダ](template_meta_programming.md#SS_12_7_2_2)」参照)を使用する
  (std::anyはunionの代替えにはならないので、このような場合には使用しない)。

### 2.1.7 配列 <a id="SS_2_1_7"></a>
* 列型オブジェクトは以下で述べるような問題や、
  [AAAスタイル](cpp_idioms.md#SS_17_11_1)で生成できない等の様々な問題を起こしやすいため、
...
* 配列の全要素にアクセスするような繰り返し処理には[範囲for文](core_lang_spec.md#SS_15_9_2)を使用する。

* [演習-配列の範囲for文](exercise_q.md#SS_18_1_6)

### 2.1.8 型エイリアス <a id="SS_2_1_8"></a>
...
* [演習-エイリアス](exercise_q.md#SS_18_1_7)

### 2.1.9 const/constexprインスタンス <a id="SS_2_1_9"></a>
* インスタンス、インスタンスへのポインタ、インスタンスへのリファレンス等に対して、
    * [constexpr変数](core_lang_spec.md#SS_15_5_2)をパラメータにした場合、コンパイル時に定数として評価できる関数は、
      [constexpr関数](core_lang_spec.md#SS_15_5_3)として宣言する。
    * コンパイル時に必ず定数として評価したい[constexpr関数](core_lang_spec.md#SS_15_5_3)には、
      [consteval](core_lang_spec.md#SS_15_5_7)を使用する。
    * constexprにはできないが、const(「[constインスタンス](core_lang_spec.md#SS_15_4_12)」にはできるインスタンスは、
      constとして定義する。関数の仮引数になっているリファレンスやポインタをconstにすることは特に重要である
    * 文字列リテラルのアドレスを非constポインタ型変数に代入しない(「[リテラル](core_lang_spec.md#SS_15_2)」参照)。
...
* constは[west-const](cpp_idioms.md#SS_17_11_3)に従って記述する。
...
* [演習-constの意味](exercise_q.md#SS_18_1_8)
* [演習-const/constexpr](exercise_q.md#SS_18_1_9)

### 2.1.10 リテラル <a id="SS_2_1_10"></a>
...
* 文字列リテラル("xxx")はconstオブジェクトとして扱う
  (「[const/constexprインスタンス](programming_convention.md#SS_2_1_9)」、「[std::string型リテラル](core_lang_spec.md#SS_15_2_6_2)」参照)。
* 長い[汎整数型](core_lang_spec.md#SS_15_1_4)リテラルを使用する場合は、適切に区切りを入れる(C++14)。
...
#### 2.1.10.1 生文字列リテラル <a id="SS_2_1_10_1"></a>
* 正規表現を表す文字列リテラルを使用する場合、文字列内のエスケープシーケンスをエスケープするのでなく、
  には[生文字列リテラル](core_lang_spec.md#SS_15_2_1)を使用する。これにより正規表現の可読性が向上する。
...
* [演習-危険なconst_cast](exercise_q.md#SS_18_1_10)
* [演習-リテラル](exercise_q.md#SS_18_1_11)

### 2.1.11 型推論 <a id="SS_2_1_11"></a>
#### 2.1.11.1 auto <a id="SS_2_1_11_1"></a>
* [AAAスタイル](cpp_idioms.md#SS_17_11_1)に従い適切にautoを使用する。
...
* auto、[decltype](core_lang_spec.md#SS_15_11_15), decltype(auto)の微妙な違いに気を付ける。
...
* 通常の関数の定義に「[autoパラメータによる関数テンプレートの簡易定義](core_lang_spec.md#SS_15_11_13)」の使用を避ける。
  [autoパラメータによる関数テンプレートの簡易定義](core_lang_spec.md#SS_15_11_13)を使ったインライン関数は柔軟すぎる。

* [演習-適切なautoの使い方](exercise_q.md#SS_18_1_12)

### 2.1.12 インスタンスの初期化 <a id="SS_2_1_12"></a>
* 関数内のオブジェクトは、出来る限り[AAAスタイル](cpp_idioms.md#SS_17_11_1)を用いて宣言し、同時に初期化する。
* [算術型](core_lang_spec.md#SS_15_1_3)の宣言に[AAAスタイル](cpp_idioms.md#SS_17_11_1)が使えない場合、
  「代入演算子を伴わない[一様初期化](core_lang_spec.md#SS_15_6_6)」を使用する。
...
* リファレンスやポインタの宣言に[AAAスタイル](cpp_idioms.md#SS_17_11_1)が使えない場合、
  「代入演算子を伴わない[一様初期化](core_lang_spec.md#SS_15_6_6)」か「=による初期化」を使用する。
  「代入演算子を伴う一様初期化」、「()による初期化」を使用しない。
...
* 構造体やクラス型オブジェクトの宣言に[AAAスタイル](cpp_idioms.md#SS_17_11_1)が使えない場合、
    * 「代入演算子を伴わない[一様初期化](core_lang_spec.md#SS_15_6_6)」を使用する。
...
* decltypeによるオブジェクトの宣言は、[AAAスタイル](cpp_idioms.md#SS_17_11_1)と同様に行う。
...
* 配列の宣言には、「代入演算子を伴わない[一様初期化](core_lang_spec.md#SS_15_6_6)」を使用する。
...
* 宣言時にポインタ変数の初期値が決まらない場合、nullptrで初期化する(「[リテラル](core_lang_spec.md#SS_15_2)」参照)。
...
* [演習-インスタンスの初期化](exercise_q.md#SS_18_1_15)
* [演習-vector初期化](exercise_q.md#SS_18_1_14)
* [演習-ポインタの初期化](exercise_q.md#SS_18_1_13)


### 2.1.13 rvalue <a id="SS_2_1_13"></a>
* 関数の仮引数以外のリファレンスで[rvalue](core_lang_spec.md#SS_15_7_1_2)をバインドしない
...
## 2.2 クラスとオブジェクト <a id="SS_2_2"></a>
### 2.2.1 ファイルの使用方法 <a id="SS_2_2_1"></a>
* 下記の例外を除き、一つのクラスはそれを宣言、定義する1つのヘッダファイルと、
  一つの.cppファイルによって構成する。
    ...
    * 「一つのヘッダファイル(a.h)と、一つの.cpp(a.cpp)で構成されたクラスA」のみをサポートするクラス
      (Aのインターフェースや実装専用に定義されたクラス(「[Pimpl](cpp_idioms.md#SS_17_2_1)」参照))は、
      a.h、a.cppで宣言、定義する。

### 2.2.2 クラスの規模 <a id="SS_2_2_2"></a>
#### 2.2.2.1 行数 <a id="SS_2_2_2_1"></a>
...
#### 2.2.2.2 メンバの数 <a id="SS_2_2_2_2"></a>
...
#### 2.2.2.3 凝集性 <a id="SS_2_2_2_3"></a>
* 単なるデータホルダー(アプリケーションの設定データを保持するようなクラス等)や、
  ほとんどの振る舞いを他のクラスに委譲するようなクラスを除き、
  [凝集性](cpp_idioms.md#SS_17_14_14)が高くなるように設計する。
* [クラス凝集性のクライテリア](cpp_idioms.md#SS_17_7_3)に従い、凝集性を判断し、凝集性が著しく低いクラスを作らないようにする。

* [演習-凝集性の意味](exercise_q.md#SS_18_2_1)
* [演習-凝集性の向上](exercise_q.md#SS_18_2_2)


### 2.2.3 アクセスレベルと隠蔽化 <a id="SS_2_2_3"></a>
...
* 全てのメンバ変数はprivateにする。
    * メンバ変数にアクセスしたい場合は、Accessorメンバ関数を経由させる
      (「[Accessor](cpp_idioms.md#SS_17_1_6)」参照)。その場合でもsetterは控えめに使用する。
...
* [NVI(non virtual interface)](cpp_idioms.md#SS_17_1_8)に従う。従って、
...
### 2.2.4 メンバ関数 <a id="SS_2_2_4"></a>
* 可能な場合(メンバに直接アクセスしない場合)、メンバ関数をstaticにする。
* コンパイル時に戻り値が確定するメンバ関数は[constexpr関数](core_lang_spec.md#SS_15_5_3)と宣言する。
...
* 非静的メンバの[ハンドル](cpp_idioms.md#SS_17_14_8)を返すメンバ関数を持つオブジェクトが
  [rvalue](core_lang_spec.md#SS_15_7_1_2)である場合、
  そのオブジェクトからその関数を呼び出した戻り値(メンバへのハンドル)を変数で保持しない
  (そのハンドルは[danglingリファレンス](cpp_idioms.md#SS_17_13_2)/[danglingポインタ](cpp_idioms.md#SS_17_13_3)になっている)。
  そういった使用方法が必要ならばlvalue修飾、[rvalue修飾](core_lang_spec.md#SS_15_8_7_1)を用いたオーバーロード関数を定義する。
...
* [演習-メンバ関数の修飾](exercise_q.md#SS_18_3_2)

#### 2.2.4.1 特殊メンバ関数 <a id="SS_2_2_4_1"></a>
* [特殊メンバ関数](core_lang_spec.md#SS_15_6_1)
    * デフォルトコンストラクタ
    * copyコンストラクタ
    * copy代入演算子(operator =)
    * moveコンストラクタ
...
* リソース管理等の都合からコンパイラが生成するデストラクタでは機能が不十分な場合、
  ...
  これらを使用しない(「[Copy-And-Swap](cpp_idioms.md#SS_17_1_4)」参照)。

* [演習-特殊メンバ関数の削除](exercise_q.md#SS_18_3_3)

#### 2.2.4.2 コンストラクタ <a id="SS_2_2_4_2"></a>
* クラスが複数の初期化方法を提供する場合でも、
  デフォルト引数を使用し、できる限りコンストラクタを一つに集約する。
* 一つのコンストラクタに集約できない場合、[委譲コンストラクタ](core_lang_spec.md#SS_15_6_1_3)等により処理の重複を防ぐ。
  [非静的なメンバ変数](programming_convention.md#SS_2_2_5_2)処理の重複を避けることは特に重要である。
* オブジェクトの初期化が完了するまでは派生クラスの仮想関数呼び出し等の
  [RTTI](programming_convention.md#SS_2_5_9)機能を使うことはできないため(「[ポリモーフィックなクラス](core_lang_spec.md#SS_15_4_8)」参照)、
...
* クラスが解放責務を持つポインタ型メンバ変数を持つならば、copyコンストラクタ、
  copy代入演算子に対して以下のいずれかを行い、[シャローコピー](cpp_idioms.md#SS_17_12_1)が行われないようにする
  (このルールはファイルディスクリプタ等のリソース管理をするクラス全般に当てはまる)。
    * [ディープコピー](cpp_idioms.md#SS_17_12_2)をさせる。
    * = deleteする(「[特殊メンバ関数](core_lang_spec.md#SS_15_6_1)」参照)。

  またこの場合、moveコンストラクタ、move代入演算子の定義を検討する(「[Copy-And-Swap](cpp_idioms.md#SS_17_1_4)」参照)。

* 非explicitなコンストラクタによる[暗黙の型変換](core_lang_spec.md#SS_15_6_2_2)
  が不要なクラスのコンストラクタに関しては、下記の目的のためにexplicitと宣言する。

    * 仮引数一つのコンストラクタに関しては、[暗黙の型変換抑止](core_lang_spec.md#SS_15_6_2_3)する。
    * 仮引数二つ以上のコンストラクタに関しては、
      代入演算子での[一様初期化](core_lang_spec.md#SS_15_6_6)ができないようにする。  
...
* 派生クラスが基底クラスの全コンストラクタを必要とする場合、
  [継承コンストラクタ](core_lang_spec.md#SS_15_6_1_2)を使用する。

* デフォルト引数はインターフェース関数の呼び出しを簡略化する目的で使用するべきであるため、
  private関数にデフォルト引数を持たせない。

* [演習-委譲コンストラクタ](exercise_q.md#SS_18_3_4)

#### 2.2.4.3 copyコンストラクタ、copy代入演算子 <a id="SS_2_2_4_3"></a>
* copyコンストラクタ、copy代入演算子は[copyセマンティクス](cpp_idioms.md#SS_17_5_2)に従わせる。
* copyコンストラクタ、copy代入演算子の引数はconstリファレンスにする。
* [RVO(Return Value Optimization)](core_lang_spec.md#SS_15_15_1)により、
  copyコンストラクタの呼び出しは省略されることがあるため、
  copyコンストラクタ、copy代入演算子はコピー以外のことをしない。
* copy代入演算子は[lvalue修飾](core_lang_spec.md#SS_15_8_7_2)をする。
...
* [演習-copyコンストラクタ](exercise_q.md#SS_18_3_5)

#### 2.2.4.4 moveコンストラクタ、move代入演算子 <a id="SS_2_2_4_4"></a>
* moveコンストラクタ、move代入演算子は[moveセマンティクス](cpp_idioms.md#SS_17_5_3)に従わせる。
...
* [演習-moveコンストラクタ](exercise_q.md#SS_18_3_6)  

#### 2.2.4.5 初期化子リストコンストラクタ <a id="SS_2_2_4_5"></a>
* [初期化子リストコンストラクタ](core_lang_spec.md#SS_15_6_1_1)は、コンテナクラスの初期化のためのみに定義する。
* 初期化子リストコンストラクタと同じ仮引数を取り得るコンストラクタを定義しない。

#### 2.2.4.6 デストラクタ <a id="SS_2_2_4_6"></a>
...
#### 2.2.4.7 オーバーライド <a id="SS_2_2_4_7"></a>
* [オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_17_13_1)に注意する。
...
* privateやprotectedなオーバーライド関数にはデフォルト引数を持たさない
  (「[実引数/仮引数](programming_convention.md#SS_2_3_4)」参照)。
  さらに[NVI(non virtual interface)](cpp_idioms.md#SS_17_1_8)にも従うことにより、
  上の条項の示した一連のオーバーライド関数のデフォルト引数の一致について考慮の必要がなくなり、
  且つこのクラスのユーザはデフォルト引数が使用できるようになる。

* [演習-オーバーライド関数の修飾](exercise_q.md#SS_18_3_8)  


### 2.2.5 メンバ変数 <a id="SS_2_2_5"></a>
#### 2.2.5.1 メンバ変数の数  <a id="SS_2_2_5_1"></a>
* constexprでなく、publicやprotectedなメンバ変数を宣言しない。
* クラスの可変な状態を表すメンバ変数(non-const, non-static)は4個以内に留める(「[クラス凝集性のクライテリア](cpp_idioms.md#SS_17_7_3)」参考)。

#### 2.2.5.2 非静的なメンバ変数 <a id="SS_2_2_5_2"></a>
* すべての非静的なメンバ変数は、コンストラクタ終了時までに明示的に初期化する。
* 多くのコンパイラや静的解析ツールはインスペクタは、
  [NSDMI](core_lang_spec.md#SS_15_6_7_1)、[初期化子リストでの初期化](core_lang_spec.md#SS_15_6_7_2)による初期化の漏れについては容易に発見、
  指摘できることが多い。
* constメンバ変数は、[NSDMI](core_lang_spec.md#SS_15_6_7_1)、
  [初期化子リストでの初期化](core_lang_spec.md#SS_15_6_7_2)でなければ初期化できないため、それ以外に方法がない場合を除き、
  [コンストラクタ内での非静的なメンバ変数の初期値の代入](core_lang_spec.md#SS_15_6_7_3)の使用を避ける。
* 非静的なメンバ変数はクラス内で定義された順序に従い初期化されるため、
  [初期化子リストでの初期化](core_lang_spec.md#SS_15_6_7_2)の順序を定義順序と同じにすることで可読性を向上させる。
* クラスがただ一つのコンストラクタを持つ場合、
  [NSDMI](core_lang_spec.md#SS_15_6_7_1)と[初期化子リストでの初期化](core_lang_spec.md#SS_15_6_7_2)を混在させない。
  従って、[初期化子リストでの初期化](core_lang_spec.md#SS_15_6_7_2)を必要とするメンバ変数が一つでもある場合は、
  すべての変数の初期化を[初期化子リストでの初期化](core_lang_spec.md#SS_15_6_7_2)で行う。
...
* クラスが複数のコンストラクタを持つ場合、
  すべてのメンバ変数に対して[NSDMI](core_lang_spec.md#SS_15_6_7_1)を行い(デフォルト値の設定)、
  デフォルト値とは異なる初期値を持つ変数に対してのみ、
  コンストラクタ毎に[初期化子リストでの初期化](core_lang_spec.md#SS_15_6_7_2)を行う。
...
* [演習-メンバ変数の初期化方法の選択](exercise_q.md#SS_18_2_3)
* [演習-メンバの型](exercise_q.md#SS_18_2_4)
* [演習-メンバ変数の初期化](exercise_q.md#SS_18_2_5)

#### 2.2.5.3 静的なメンバ変数/定数の初期化 <a id="SS_2_2_5_3"></a>
...
#### 2.2.5.4 mutableなメンバ変数 <a id="SS_2_2_5_4"></a>
...
### 2.2.6 継承/派生 <a id="SS_2_2_6"></a>
* 派生は最大2回程度までに留める。やむを得ず階層が深くなる場合、
  コードの静的解析等を使用し派生関係を明確にする(「[ポリモーフィックなクラス](core_lang_spec.md#SS_15_4_8)」参照)。
* 実装の継承よりも、包含、委譲を優先的に使用する。やむを得ず実装の継承を行う場合は、
  private継承を使用する。 実装の継承をしたクラスがfinalでないならば、protected継承を使用する
  ([CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_17_1_5)等は例外的に認められる)。
...
#### 2.2.6.1 インターフェースの継承 <a id="SS_2_2_6_1"></a>
...
* C#やJavaのinterfaceが必要ならば(インタフェースと実装の完全分離をしたい場合等)、
  ...
  (もしくはそのクラスに[NVI(non virtual interface)](cpp_idioms.md#SS_17_1_8)を適用したクラス)
  を定義する。

#### 2.2.6.2 多重継承 <a id="SS_2_2_6_2"></a>
* 多重継承が不可避でない限り、多重継承は使用しない。
    * 多重継承が必要な場合、その継承の基底クラスは1つを除き、
      他の基底クラスは[インターフェースクラス](core_lang_spec.md#SS_15_4_11)にしなければならない。
* 多重継承を使用する場合、複数個の基底クラスのうち、一つを除きメンバ変数を持ってはならない。
* 多重継承を使用する場合、継承階層内に同じ基底クラスが複数回出てきてはならない
  ([ダイヤモンド継承](core_lang_spec.md#SS_15_12_10)をしない)。
...
### 2.2.7 オブジェクト <a id="SS_2_2_7"></a>
#### 2.2.7.1 スライシング <a id="SS_2_2_7_1"></a>
* オブジェクトの[スライシング](cpp_idioms.md#SS_17_12_3)には以下のいずれかで対処する。
    * [Clone(仮想コンストラクタ)](design_pattern.md#SS_8_1_3)を使用する。
    * copy代入演算子を= deleteする。

* [スライシング](cpp_idioms.md#SS_17_12_3)と類似の問題が起こるため、
  オブジェクトの配列をそのオブジェクトの基底クラスへのポインタに代入しない。

* [演習-スライシング](exercise_q.md#SS_18_2_6)

#### 2.2.7.2 オブジェクトの所有権 <a id="SS_2_2_7_2"></a>
* オブジェクトaの所有権
  (「[オブジェクトの所有権](cpp_idioms.md#SS_17_4)」参照)を持つオブジェクトもしくは関数は、
  オブジェクトaの解放責務を持つ。
* オブジェクトaの所有権を持たないオブジェクトは、
  オブジェクトaの[ハンドル](cpp_idioms.md#SS_17_14_8)をメンバ変数で保持することを出来る限り避ける
  ([Observer](design_pattern.md#SS_8_2_4)パターン等、このルール順守が困難な場合は多い)。
* クラスAのオブジェクトaが、オブジェクトbにダイナミックに生成されたとすると、  
    * オブジェクトaのポインタは`std::unique_ptr<A>`(「[RAII(scoped guard)](cpp_idioms.md#SS_17_1_3)」参照)で保持する。
    ...
    * オブジェクトaの所有権を別のオブジェクトxへ移動させる場合、
      `std::unique_ptr<A>`とstd::move()を使用する(「[オブジェクトの排他所有](cpp_idioms.md#SS_17_4_1)」参照)。
    * このようなaに複数の所有者b0、b1が存在する場合、`std::shared_ptr<A>`を使用してaを管理する。
      従って、b0、
      b1は`std::shared_ptr<A>`型のメンバを持つことになる(「[オブジェクトの共有所有](cpp_idioms.md#SS_17_4_2)」参照)。
    * オブジェクトbが`std::shared_ptr<A>`でオブジェクトaを、
      オブジェクトaが`std::shared_ptr<B>`でオブジェクトbを所有する場合、
      [オブジェクトの循環所有](cpp_idioms.md#SS_17_4_3)よるメモリリークが発生するため、
      [std::weak_ptr](stdlib_and_concepts.md#SS_16_6_3)を適切に使用する。

* [演習-オブジェクトの所有権](exercise_q.md#SS_18_2_7)

#### 2.2.7.3 オブジェクトのライフタイム <a id="SS_2_2_7_3"></a>
* [オブジェクトのライフタイム](core_lang_spec.md#SS_15_6_8)開始前、
...
* [rvalue](core_lang_spec.md#SS_15_7_1_2)はライフタイム終了間際のオブジェクトであるため、
...
* [danglingリファレンス](cpp_idioms.md#SS_17_13_2)、 [danglingポインタ](cpp_idioms.md#SS_17_13_3)に気を付ける。


## 2.3 関数 <a id="SS_2_3"></a>
### 2.3.1 関数構造のクライテリア <a id="SS_2_3_1"></a>
* 関数の規模・複雑度に関しては、
    * [サイクロマティック複雑度のクライテリア](cpp_idioms.md#SS_17_6_2)に従う。
* [関数の行数のクライテリア](cpp_idioms.md#SS_17_6_3)に従い、
    * 7 行程度を理想とする。
    * 40行以下に留める。


* [演習-関数分割](exercise_q.md#SS_18_3_7)  

### 2.3.2 オーバーロード <a id="SS_2_3_2"></a>
* [オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_17_13_1)に注意する。
...
* [オーバーライド](programming_convention.md#SS_2_2_4_7)を除き、基底クラスのメンバ関数と同じ名前を持つメンバ関数を派生クラスで宣言、
  定義しない。
  これに反すると[name-hiding](core_lang_spec.md#SS_15_12_9)のため、基底クラスのメンバ関数の可視範囲を縮小させてしまう。
...
* [演習-オーバーライド/オーバーロード](exercise_q.md#SS_18_3_9)  
* [演習-オーバーロードによる誤用防止](exercise_q.md#SS_18_3_10)  

### 2.3.3 演算子オーバーロード <a id="SS_2_3_3"></a>
* 演算子をオーバーロードする場合、
    * 単項演算子はメンバ関数で定義する。
    * 二項演算子は非メンバ関数で定義する。
* &&, ||, カンマ(,)をオーバーロードしない。
...
* 演算子をオーバーロードする場合、それが自然に使えるようにする。
    ...
    * copy(またはmove)代入演算子を定義する場合、copy(またはmove)コンストラクタも定義する
      (その際、コードクローンを作りがちなので注意する(「[Copy-And-Swap](cpp_idioms.md#SS_17_1_4)」参照))。
...
* 比較演算子のオーバーロードする場合、
    * C++20であれば、[<=>演算子](core_lang_spec.md#SS_15_6_4_1)を定義する。
    * C++17以下であれば、`operator==`と`operator<`の2つの演算子がを定義し、
      [std::rel_ops](stdlib_and_concepts.md#SS_16_11_1)を使用する。

* [ユーザ定義リテラル演算子](core_lang_spec.md#SS_15_2_6_1)のサフィックスには、
...
### 2.3.4 実引数/仮引数 <a id="SS_2_3_4"></a>
* 仮引数(「[実引数/仮引数](core_lang_spec.md#SS_15_14_7)」参照)の数は、4個程度を上限とする。
  引数が多くなりすぎる場合、その関数の引数用の構造体を定義し、それを使用して関数を呼び出す。
  この場合、[指示付き初期化](core_lang_spec.md#SS_15_10_4)を使用する。

* 「[関数設計のガイドライン](cpp_idioms.md#SS_17_6)」の「[関数の引数と戻り値の型](cpp_idioms.md#SS_17_6_1)」に従う。

* 仮引数を関数の戻り値として利用する場合、
    * 「関数が、仮引数がnullptrである場合の処理を行う」場合、ポインタ渡しにする。
    * 「関数が、仮引数がnullptrでないことを前提している」場合、リファレンス渡しにする。

* [forwardingリファレンス](core_lang_spec.md#SS_15_8_3)を仮引数とする関数テンプレートでは、仮引数は非constにする。

* 継承の都合等で、使用しないにもかかわらず定義しなければならない仮引数には名前を付けない。
  仮引数が使用されていない警告の抑止のために[属性構文](core_lang_spec.md#SS_15_9_1)を使わない。
...
* 実引数として使用される配列がポインタ型へ暗黙に変換されることを前提に、
  ...
  (「[スライシング](cpp_idioms.md#SS_17_12_3)」で述べたように、
...
* [演習-仮引数の修飾](exercise_q.md#SS_18_3_11)  

### 2.3.5 自動変数 <a id="SS_2_3_5"></a>
* 一つの文で複数の変数の宣言をしない。
...
### 2.3.6 戻り値型 <a id="SS_2_3_6"></a>
* メモリアロケータ以外の関数の戻り値をvoid\*にしない。
* 避けがたい理由なしに以下のシンタックスを使用しない。
    * [戻り値型を後置する関数宣言](core_lang_spec.md#SS_15_11_17)
    * [関数の戻り値型auto](core_lang_spec.md#SS_15_11_18)
    * [後置戻り値型auto](core_lang_spec.md#SS_15_11_19)
...
* 戻り値型は「[関数の引数と戻り値の型](cpp_idioms.md#SS_17_6_1)」に従う。

* 関数が複数の値を返す場合、[std::optional](stdlib_and_concepts.md#SS_16_9)、std::pair、std::tupple、
...
* 処理の成否をbool等で通知し、成功時の戻り値をリファレンス引数で戻す関数や、
  ...
  代わりにC++17で導入された[std::optional](stdlib_and_concepts.md#SS_16_9)を使用する。
...
### 2.3.7 constexpr関数 <a id="SS_2_3_7"></a>
* 引数が[constexpr](core_lang_spec.md#SS_15_5_1)の場合、コンパイル時に評価が確定する関数テンプレートもしくはinline関数は、
  [constexpr関数](core_lang_spec.md#SS_15_5_3)として宣言する。
* [constexpr関数](core_lang_spec.md#SS_15_5_3)がコンパイル時に評価される必要がある場合、
  [constexpr](core_lang_spec.md#SS_15_5_1)の代わりに[consteval](core_lang_spec.md#SS_15_5_7)を使用する。

* [演習-constexpr関数](exercise_q.md#SS_18_3_12)  

### 2.3.8 スレッドセーフ性 <a id="SS_2_3_8"></a>
* 関数、メンバ関数はなるべく[スレッドセーフ](cpp_idioms.md#SS_17_14_3)に実装する。
...
### 2.3.9 エクセプション処理 <a id="SS_2_3_9"></a>
* 関数はそれが不可避でない限り、[no-fail保証](core_lang_spec.md#SS_15_13_7_1)をする。
  [no-fail保証](core_lang_spec.md#SS_15_13_7_1)関数は[noexcept](core_lang_spec.md#SS_15_13_6)を使用してそのことを明示する。
* throwをせざるを得ない場合、最低でも[基本的な安全性の保証](core_lang_spec.md#SS_15_13_7_3)をする。
...
* 特別な理由がない限り、コンストラクタ呼び出しは[noexcept](core_lang_spec.md#SS_15_13_6)と宣言する。
...
* エクセプションをthrowしないことが確定している関数は、[noexcept](core_lang_spec.md#SS_15_13_6)と宣言する。
  move代入演算子を[noexcept](core_lang_spec.md#SS_15_13_6)と宣言することは特に重要である。
...
* try-catchが不可避である場合、以下の理由によりconstリファレンスで受け取る。
    * 実態で受け取るとオブジェクトの[スライシング](cpp_idioms.md#SS_17_12_3)が起こる場合がある。
    * 受け取ったエクセプションオブジェクトを書き換えるべきではない。

* エクセプションによるリソースリークを避けるため[RAII(scoped guard)](cpp_idioms.md#SS_17_1_3)でリソースを管理する。
...
* [exception-unfriendly](core_lang_spec.md#SS_15_13_8)な関数はエクセプションを発生させないようにする。
* エクセプションをthrowする場合、独自定義したオブジェクトを使用しない。
  ...
  (「[ファイル位置を静的に保持したエクセプションクラスの開発](template_meta_programming.md#SS_12_7_6_4)」参照)。


* noexceptと宣言された関数へのポインタへ、noexceptでない関数のポインタを代入しない
  (C++17では[ill-formed](core_lang_spec.md#SS_15_14_1)になる)。
...
* [演習-エクセプションの型](exercise_q.md#SS_18_3_13)  

### 2.3.10 ビジーループ <a id="SS_2_3_10"></a>
* ビジーループを使わない。[std::condition_variable](stdlib_and_concepts.md#SS_16_4_4)を使用してイベントドリブンにする。
...
### 2.3.11 非メンバ関数 <a id="SS_2_3_11"></a>
...
* コンパイル時に戻り値が確定する関数は[constexpr関数](core_lang_spec.md#SS_15_5_3)として宣言する。

* [演習-非メンバ関数の宣言](exercise_q.md#SS_18_3_1)

## 2.4 構文 <a id="SS_2_4"></a>

### 2.4.1 複合文 <a id="SS_2_4_1"></a>
...
### 2.4.2 switch文 <a id="SS_2_4_2"></a>
* caseラベル、defaultラベルに関連付けられた一連の文はできだけフォールスルーさせない。
  実装がシンプルになる等の理由からフォールスルーさせる場合、
  [属性構文](core_lang_spec.md#SS_15_9_1)を使用しそれが意図的であることを明示するため以下のような記述する。
...
* switch文のオペランド変数を生成する場合、
  できるだけ[初期化付きswitch文](core_lang_spec.md#SS_15_9_4_4)を使用し、その変数のスコープを最小に留める。

### 2.4.3 if文 <a id="SS_2_4_3"></a>
...
* ifの条件式が、コンパイル時に定まるのであれば、[constexpr if文](core_lang_spec.md#SS_15_11_12)を使用する。

* if文のオペランド変数を生成する場合、
  できるだけ[初期化付きif文](core_lang_spec.md#SS_15_9_4_3)を使用し、その変数のスコープを最小に留める。

### 2.4.4 while文 <a id="SS_2_4_4"></a>
* while文には、[初期化付きif文](core_lang_spec.md#SS_15_9_4_3)/[初期化付きswitch文](core_lang_spec.md#SS_15_9_4_4)のような構文は存在しないが、
  while文のオペランド変数を生成するする場合、
  [初期化付きfor文(従来のfor文)](core_lang_spec.md#SS_15_9_4_1)を使用し、その変数のスコープを最小に留める。

### 2.4.5 範囲for文 <a id="SS_2_4_5"></a>
* 配列やコンテナの全要素にアクセスするような繰り返し処理には、
  [off-by-oneエラー](https://ja.wikipedia.org/wiki/Off-by-one%E3%82%A8%E3%83%A9%E3%83%BC)
  が避けられ、従来よりもシンプルに記述できる[範囲for文](core_lang_spec.md#SS_15_9_2)を使用する。
...
* 独自のコンテナクラスを定義する場合、標準ライブラリのコンテナと同様の要件を満たすbegin()、end()や、
  cbegin()、cend()も定義し、そのコンテナに[範囲for文](core_lang_spec.md#SS_15_9_2)を適用できるようにする。

* [演習-コンテナの範囲for文](exercise_q.md#SS_18_4_1)  

### 2.4.6 制御文のネスト <a id="SS_2_4_6"></a>
* breakとの関係がわかりづらい、ブロックが巨大になる等の問題があるため、
  if, for, while, do-while, switch文に付随するブロックの中にswitch文を書かない。

### 2.4.7 return文 <a id="SS_2_4_7"></a>
* returnの後に括弧をつけない。
...
### 2.4.8 goto文 <a id="SS_2_4_8"></a>
* 二重以上のループを抜ける目的以外でgotoを使用しない。
* 二重以上のループを抜ける目的でgotoを使用する場合、gotoのジャンプ先ラベルはそのループの直後に置く。

### 2.4.9 ラムダ式 <a id="SS_2_4_9"></a>
* [ラムダ式](core_lang_spec.md#SS_15_10_3)を複雑にしない。
    * できるだけワンライナーにする。
    * 必ず10行以下にする。
...
* C++17以降では、 コンパイル時に戻り値が確定するラムダ式の呼び出し式は定数にできるため、
  そのようなラムダ式は[constexprラムダ](core_lang_spec.md#SS_15_5_9)として宣言する。
...
* [演習-ラムダ式](exercise_q.md#SS_18_4_2)  
* [演習-ラムダ式のキャプチャ](exercise_q.md#SS_18_4_3)  

### 2.4.10 マクロの中の文 <a id="SS_2_4_10"></a>
...
## 2.5 演算子 <a id="SS_2_5"></a>

### 2.5.1 優先順位 <a id="SS_2_5_1"></a>
* 規格上で[演算子のオペランドの評価順位](core_lang_spec.md#SS_15_14_12)が決まっていても、一見優先順位が分かりづらい式では、
  順序を明示するために丸括弧を使う。
...
### 2.5.2 代入演算 <a id="SS_2_5_2"></a>
* [単純代入](core_lang_spec.md#SS_15_14_8)のみからなる文を除き、1つの文で複数の代入を行わない。
...
### 2.5.3 ビット演算 <a id="SS_2_5_3"></a>
* 「[ビットシフトにおける未定義動作](core_lang_spec.md#SS_15_1_5_1)」を回避することは困難であるため、
  特別な理由がない限り、 可読性と安全性を優先して、ビット演算にはstd::bitsetや[BitmaskType](cpp_idioms.md#SS_17_2_3)を使用する。

### 2.5.4 論理演算 <a id="SS_2_5_4"></a>
* &&や||の論理演算子の右オペランドで[副作用](cpp_idioms.md#SS_17_14_16)のある処理をしない。
...
* [演習-条件演算子](exercise_q.md#SS_18_5_1)  

### 2.5.6 メモリアロケーション <a id="SS_2_5_6"></a>
#### 2.5.6.1 new <a id="SS_2_5_6_1"></a>
* オブジェクトのダイナミックな生成には、特別な理由がない限りnewを使用せず、
  [std::make_unique](stdlib_and_concepts.md#SS_16_6_1_1)や[std::make_shared](stdlib_and_concepts.md#SS_16_6_2_1)を使用する。
  また、特別な理由でnewした場合、そのポインタは[スマートポインタ](stdlib_and_concepts.md#SS_16_6)で管理する。
* [std::shared_ptr](stdlib_and_concepts.md#SS_16_6_2)でダイナミックに生成したオブジェクトを管理する場合、
  [オブジェクトの循環所有](cpp_idioms.md#SS_17_4_3)が発生しないように気を付ける(適切に[std::weak_ptr](stdlib_and_concepts.md#SS_16_6_3)を使う)。
* [プレースメントnew](core_lang_spec.md#SS_15_6_9)を使用しない。
* `new T[N]`を使用しない。代わりにstd::arrayをダイナミックに生成するか、std::vectorを使用する。
* [new (std::nothrow)](core_lang_spec.md#SS_15_6_10)を使わない限り、
...
#### 2.5.6.2 delete <a id="SS_2_5_6_2"></a>
* [不完全型](core_lang_spec.md#SS_15_4_6)のオブジェクトへのポインタをdeleteしない。
  特に「[Pimpl](cpp_idioms.md#SS_17_2_1)」を使用する場合には注意が必要である。
...
* [演習-delete](exercise_q.md#SS_18_5_2)  

### 2.5.7 sizeof <a id="SS_2_5_7"></a>
...
* 上記例を除き、sizeof演算子のオペランドは一見[副作用](cpp_idioms.md#SS_17_14_16)を持っているような式を含んではならない。
...
* [演習-sizeof](exercise_q.md#SS_18_5_3)  

### 2.5.8 ポインタ間の演算 <a id="SS_2_5_8"></a>
...
### 2.5.9 RTTI <a id="SS_2_5_9"></a>
* [Run-time Type Information](core_lang_spec.md#SS_15_4_10)を使用したラインタイム時の型による場合分けは、
  それ以外に解決方法がない場合や、実装が大幅にシンプルになる場合を除き行わない
  (「[等価性のセマンティクス](cpp_idioms.md#SS_17_5_1)」参照)。
...
* [演習-dynamic_castの削除](exercise_q.md#SS_18_5_4)  

### 2.5.10 キャスト、暗黙の型変換 <a id="SS_2_5_10"></a>
...
* [演習-キャスト](exercise_q.md#SS_18_5_5)  

## 2.6 プリプロセッサ命令 <a id="SS_2_6"></a>
...
* ヘッダファイル内での#if/#ifdef/#ifndefに関しては、以下の用途以外では使わない。
    * 二重インクルードガード(「[二重読み込みの防御](programming_convention.md#SS_2_7_3)」参照)
    * Cとシェアするヘッダファイルでの下記例
...
## 2.7 ソースコードファイルとディレクトリ <a id="SS_2_7"></a>

- ソースコードファイル全体は、適切に[パッケージ](cpp_idioms.md#SS_17_9_2)に分割する。
- ソースコードファイルの最小構成は[ファイルペア](cpp_idioms.md#SS_17_9_1)を形成しなければならない。
...
### 2.7.1 識別子の宣言、定義 <a id="SS_2_7_1"></a>
...
* [ファイルペア](cpp_idioms.md#SS_17_9_1)の実装ファイルは、対応するヘッダファイルをインクルードしなければならない。

### 2.7.2 依存関係 <a id="SS_2_7_2"></a>
* 不要/不適切な依存関係(「[インターフェース分離の原則(ISP)](solid.md#SS_7_4)」や
  「[依存関係逆転の原則(DIP)](solid.md#SS_7_5)」への違反)を作らない。
    ...
    * SOLIDの原則やデザインパターン、イデオム等を適切に使用することにより、依存関係を適切に保つ。
        * 依存関係の伝搬を回避したい場合、[Pimpl](cpp_idioms.md#SS_17_2_1)イデオムを使い実装の詳細を隠蔽する。
        * 上位概念が下位概念に依存することを避ける場合、
          「[依存関係逆転の原則(DIP)](solid.md#SS_7_5)」での例や[Observer](design_pattern.md#SS_8_2_4)等を適用する。
    * パッケージ間の依存関係は、[非循環依存の原則(ADP)](cpp_idioms.md#SS_17_8_4)を守る。
...
* ヘッダファイル間の依存関係を最小にとどめるために、
  前方宣言や[前方宣言ヘッダ(`_fwd.h`)](cpp_idioms.md#SS_17_1_2)イディオムやを適切に使用する。
...
* 標準ライブラリのクラス(class, struct, enum, enum class)の前方宣言をしない
  ...
  このような前方宣言を行うと[ODR](core_lang_spec.md#SS_15_14_10)違反による[未定義動作](core_lang_spec.md#SS_15_14_3)につながる可能性がある)。
  `<ios>`で宣言される型は`<iosfwd>`で前方宣言されている)。


### 2.7.3 二重読み込みの防御 <a id="SS_2_7_3"></a>
...
### 2.7.4 ヘッダファイル内の#include <a id="SS_2_7_4"></a>
...
* ヘッダファイルが外部からインポートする型(class、struct、enum)
  ...
  前方宣言や[前方宣言ヘッダ(`_fwd.h`)](cpp_idioms.md#SS_17_1_2)を使い依存関係を小さくする。 
...
## 2.8 スコープ <a id="SS_2_8"></a>
### 2.8.1 スコープの定義と原則 <a id="SS_2_8_1"></a>
この章で扱うスコープを下記のように定義する(「[ソースコードファイルとディレクトリ](programming_convention.md#SS_2_7)」参照)。

1. グローバル
2. [パッケージ](cpp_idioms.md#SS_17_9_2)外部公開名前空間
3. [パッケージ](cpp_idioms.md#SS_17_9_2)外部非公開名前空間
...
その識別子は[パッケージ](cpp_idioms.md#SS_17_9_2)外部非公開なヘッダファイルに宣言、定義されているため、
...
* このドキュメント執筆時のコンパイラ/ビルダのC++20での[モジュール](core_lang_spec.md#SS_15_10_2)のサポート状況が
  万全ではないため、
    * モジュールを定義するためのmoduleを使用しない。
    * モジュール外に公開する識別子を定義するexport使用しない。
    * exportされた識別子を使用するためにimportを使用しない。

* [name-hiding](core_lang_spec.md#SS_15_12_9)を起こすとコードの可読性が著しく低下するため、
...
### 2.8.2 名前空間 <a id="SS_2_8_2"></a>
* グローバル名前空間には下記以外の識別子を定義、宣言しない。
    * main関数
    * グローバルnewのオーバーロード
    * Cとシェアする識別子
* [パッケージ](cpp_idioms.md#SS_17_9_2)毎に名前空間を定義する
  (「[ソースコードファイルとディレクトリ](programming_convention.md#SS_2_7)」、[名前空間名](naming_practice.md#SS_5_2_11)」参照)。
...
### 2.8.3 using宣言/usingディレクティブ <a id="SS_2_8_3"></a>
* 識別子のインポートのための[using宣言](core_lang_spec.md#SS_15_12_14)は下記のような場合のみに使用する
  (「[継承コンストラクタ](core_lang_spec.md#SS_15_6_1_2)」、「[オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_17_13_1)」参照)。
...
* 下記のような場合を除き、[usingディレクティブ](core_lang_spec.md#SS_15_12_15)は使用しない。
...
* [演習-usingディレクティブ](exercise_q.md#SS_18_6_1)  

### 2.8.4 ADLと名前空間による修飾の省略 <a id="SS_2_8_4"></a>
* 名前空間の修飾を省略した識別子のアクセスには、
  下記のような副作用があるため、[ADL](core_lang_spec.md#SS_15_12_5)を使用する目的以外で使用しない
...
### 2.8.5 名前空間のエイリアス <a id="SS_2_8_5"></a>
...
### 2.9.1 前置/後置演算子の選択 <a id="SS_2_9_1"></a>
...
### 2.9.2 operator X、operator x=の選択 <a id="SS_2_9_2"></a>
...
### 2.9.3 関数の戻り値オブジェクト <a id="SS_2_9_3"></a>
* 戻り値型は「[関数の引数と戻り値の型](cpp_idioms.md#SS_17_6_1)」に従う。


### 2.9.4 move処理 <a id="SS_2_9_4"></a>
* [ディープコピー](cpp_idioms.md#SS_17_12_2)の実装を持つクラスへのcopy代入の多くがrvalueから行われるのであれば、
  moveコンストラクタや、move代入演算子も実装する。
* 関数の戻り値にローカルオブジェクトを使用する場合、
  [RVO(Return Value Optimization)](core_lang_spec.md#SS_15_15_1)の阻害になるため、そのオブジェクトをstd::moveしない。
...
### 2.9.5 std::string vs std::string const& vs std::string_view <a id="SS_2_9_5"></a>
...
### 2.9.6 extern template <a id="SS_2_9_6"></a>
* 何度もインスタンス化が行われ、
...
## 2.10 標準クラス、関数の使用制限 <a id="SS_2_10"></a>
### 2.10.1 標準ライブラリ <a id="SS_2_10_1"></a>
...
* [g++](cpp_idioms.md#SS_17_15_1)/[clang++](cpp_idioms.md#SS_17_15_2)等の優れたコンパイラを適切なオプションで使用することで、
  非推奨の機能、関数、クラスの使用を防ぐ。

#### 2.10.1.1 スマートポインタの使用制限 <a id="SS_2_10_1_1"></a>
* std::auto_ptrを使用しない(C++17で廃止)。
* ダイナミックに生成した[オブジェクトの排他所有](cpp_idioms.md#SS_17_4_1)を行う場合、`std::unique_ptr<>`を使用する。
* ダイナミックに生成した[オブジェクトの共有所有](cpp_idioms.md#SS_17_4_2)を行う場合、`std::shared_ptr<>`を使用する。
* `std::shared_ptr<>`を使用する場合、[オブジェクトの循環所有](cpp_idioms.md#SS_17_4_3)が発生しないように気を付ける。

#### 2.10.1.2 配列系コンテナクラスの使用制限 <a id="SS_2_10_1_2"></a>
...
* std::arrayを除くコンテナクラスは、
  それ自体でメモリリソースの[RAII(scoped guard)](cpp_idioms.md#SS_17_1_3)を実現しているため、newしない。

#### 2.10.1.3 std::stringの使用制限 <a id="SS_2_10_1_3"></a>
* std::stringは、
  それ自体でメモリリソースの[RAII(scoped guard)](cpp_idioms.md#SS_17_1_3)を実現しているため、newしない。
* std::stringの添字演算子[]は領域外アクセスを通知しない
  ...
  (「[安全な配列型コンテナ](template_meta_programming.md#SS_12_2_3)」参照)。
* std::string.data()は、C++のバージョンによってはNULLターミネイトが保証されていないため、
  std::string.c_str() を使用する。

#### 2.10.1.4 std::string_viewの使用制限 <a id="SS_2_10_1_4"></a>
...
### 2.10.2 POSIX系関数 <a id="SS_2_10_2"></a>
#### 2.10.2.1 使用禁止関数一覧 <a id="SS_2_10_2_1"></a>
...
#### 2.10.2.2 使用禁止関数の理由や注意点 <a id="SS_2_10_2_2"></a>
##### 2.10.2.2.1 バッファオーバーランを引き起こしやすい関数 <a id="SS_2_10_2_2_1"></a>
...
##### 2.10.2.2.2 コマンドインジェクション防止 <a id="SS_2_10_2_2_2"></a>
...
##### 2.10.2.2.3 obsolete関数 <a id="SS_2_10_2_2_3"></a>
...
##### 2.10.2.2.4 LEGACY関数 <a id="SS_2_10_2_2_4"></a>
* 以下の関数は、すでに役目を終えた。
...
##### 2.10.2.2.5 スレッドセーフでない関数 <a id="SS_2_10_2_2_5"></a>
* 以下の関数は、スレッドセーフでない。

```
    asctime(), ctime(), getgrgid(), getgrnam(), getlogin(), getpwuid(), getpwnam(), gmtime(),
    localtime(), ttyname(), 
    ctermid(), tmpnam() (引数がNULLのとき、非[リエントラント](cpp_idioms.md#SS_17_14_4)になる)
```

##### 2.10.2.2.6 標準外関数等 <a id="SS_2_10_2_2_6"></a>
* 可変長配列や、alloca()は、標準外である。

##### 2.10.2.2.7 扱いが難しい関数 <a id="SS_2_10_2_2_7"></a>
* signalの扱いは極めて難しく、安定動作をさせるのは困難である。
  「シグナルの[リエントラント](cpp_idioms.md#SS_17_14_4)問題を解決でき、使用できる関数に制限がない」という利点があるため、
   signal()の代わりに、 signalfd() を使用する。 
* 排他的にファイルをオープンできないため、tmpfile()を使用しない。代わりにmkstemp()を使用する。

#### 2.10.2.3 典型的な注意点 <a id="SS_2_10_2_3"></a>
##### 2.10.2.3.1 リソースリークを引き起こしやすい関数 <a id="SS_2_10_2_3_1"></a>
* open()/close()、fopen()/fclose()はリソースリークを引き起こしやすい。
  「[RAII(scoped guard)](#8.9)」で例示したコードやstd::fstreamを使うことでその問題を回避する。

##### 2.10.2.3.2 シンボリックリンクの検査 <a id="SS_2_10_2_3_2"></a>
...
##### 2.10.2.3.3 strncpy(), strncat()の終端 <a id="SS_2_10_2_3_3"></a>
...
##### 2.10.2.3.4 TOCTOU (Time Of Check, Time Of Use) <a id="SS_2_10_2_3_4"></a>
...
##### 2.10.2.3.5 メモリアロケーション <a id="SS_2_10_2_3_5"></a>
...
##### 2.10.2.3.6 非同期シグナル <a id="SS_2_10_2_3_6"></a>
...
## 2.11 その他 <a id="SS_2_11"></a>
### 2.11.1 assertion <a id="SS_2_11_1"></a>
...
* assert()はコンパイルオプションにより無効化されることがあるため、
  assert()の引数に[副作用](cpp_idioms.md#SS_17_14_16)のある式を入れない。
...
* [演習-アサーションの選択](exercise_q.md#SS_18_7_1)  
* [演習-assert/static_assert](exercise_q.md#SS_18_7_2)  

### 2.11.2 アセンブラ <a id="SS_2_11_2"></a>
...
### 2.11.3 言語拡張機能 <a id="SS_2_11_3"></a>
* #pragma once以外で、且つそれ以外に実装方法がない場合を除き、
  コンパイラ独自の言語拡張機能を使用しない。
* オブジェクトのアライメントが必要な場合、
    * alignas、alignofを使用する(「[プレースメントnew](core_lang_spec.md#SS_15_6_9)」参照)。
...
## 2.12 特に重要なプログラミング規約 <a id="SS_2_12"></a>
本章で取り上げた規約は、重要度という観点で様々なレベルのものが混在するため量も多く、
すぐに実践することが難しいかもしれない。
そういった場合には、まずは特に重要な下記リストを守ることから始めるのが良いだろう。

* 浮動小数点型をなるべく使わない([浮動小数点型](core_lang_spec.md#SS_15_1_12))。
...
* 関数は小さくする([サイクロマティック複雑度のクライテリア](cpp_idioms.md#SS_17_6_2))。
...
* 構文に関しては以下に気を付ける。
    ...
    * 範囲for文を積極的に使う([範囲for文](core_lang_spec.md#SS_15_9_2))。
