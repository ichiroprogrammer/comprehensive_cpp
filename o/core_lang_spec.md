...
&emsp;&emsp;&emsp; [constexpr変数](core_lang_spec.md#SS_19_5_2)  
...
これにより、[Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_21_11_5)を回避できる。
...
下記GetString0()のような関数が返すオブジェクトの内部メンバに対する[ハンドル](cpp_idioms.md#SS_21_12_8)は、
