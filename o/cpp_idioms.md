...
&emsp;&emsp;&emsp; [メモリ保護機構](cpp_idioms.md#SS_21_12_9)  
&emsp;&emsp;&emsp; [CPU例外](cpp_idioms.md#SS_21_12_10)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](cpp_idioms.md#SS_21_12_11)  
&emsp;&emsp;&emsp; [凝集性](cpp_idioms.md#SS_21_12_12)  
&emsp;&emsp;&emsp;&emsp; [凝集性の欠如](cpp_idioms.md#SS_21_12_12_1)  
&emsp;&emsp;&emsp;&emsp; [LCOM](cpp_idioms.md#SS_21_12_12_2)  

&emsp;&emsp;&emsp; [Spurious Wakeup](cpp_idioms.md#SS_21_12_13)  
&emsp;&emsp;&emsp; [Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_21_12_14)  
&emsp;&emsp;&emsp; [副作用](cpp_idioms.md#SS_21_12_15)  
&emsp;&emsp;&emsp; [Itanium C++ ABI](cpp_idioms.md#SS_21_12_16)  
...
なお、このパターンは、[std::enable_shared_from_this](stdlib_and_concepts.md#SS_20_6_2_2)の使用において前提知識となっている。
...
* エクセプション安全性  
    [no-fail保証](core_lang_spec.md#SS_19_13_7_1)をする(noexceptと宣言し、エクセプションをthrowしない)
...
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_21_12_11)によって下記テーブルのように定義する。
...
クラス構造の適・不適については、[LCOM](cpp_idioms.md#SS_21_12_12_2)によって下記テーブルのように定義する。
...
- メモリ保護違反例外:
    [メモリ保護機構](cpp_idioms.md#SS_21_12_9)の設定に反した命令を実行した場合に発生する。例えば、リードオンリー領域への書き込み、
...
### サイクロマティック複雑度 <a id="SS_21_12_11"></a>
[サイクロマティック複雑度](https://ja.wikipedia.org/wiki/%E5%BE%AA%E7%92%B0%E7%9A%84%E8%A4%87%E9%9B%91%E5%BA%A6)
とは関数の複雑さを表すメトリクスである。


### 凝集性 <a id="SS_21_12_12"></a>
[凝集性(凝集度)](https://ja.wikipedia.org/wiki/%E5%87%9D%E9%9B%86%E5%BA%A6)
とはクラス設計の妥当性を表す尺度の一種であり、
「[凝集性の欠如](cpp_idioms.md#SS_21_12_12_1)(LCOM)」というメトリクスで計測される。

* [凝集性の欠如](cpp_idioms.md#SS_21_12_12_1)メトリクスの値が1に近ければ凝集性は低く、この値が0に近ければ凝集性は高い。
...
#### 凝集性の欠如 <a id="SS_21_12_12_1"></a>
[凝集性](cpp_idioms.md#SS_21_12_12)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
#### LCOM <a id="SS_21_12_12_2"></a>
[凝集性の欠如](cpp_idioms.md#SS_21_12_12_1)とはLack of Cohesion in Methodsの和訳であり、LCOMと呼ばれる。

### Spurious Wakeup <a id="SS_21_12_13"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_21_12_14"></a>
静的初期化順序問題とは、
...
### Itanium C++ ABI <a id="SS_21_12_16"></a>
