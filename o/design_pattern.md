...
[特殊メンバ関数](term_explanation.md#SS_21_1_1)では機能が不十分であることが多い。
...
* copy代入演算子には、[エクセプション安全性の保証](cpp_standard.md#SS_19_12)がない。
...
これにより[エクセプション安全性の保証](cpp_standard.md#SS_19_12)を持つ4関数をコードクローンすることなく実装できる。
...
オブジェクトコピーによる[スライシング](term_explanation.md#SS_21_2_4_3)を回避するためのイデオムである。
...
* クラスの理解が曖昧なC++プログラマの理解を助ける(「[ポリモーフィックなクラス](cpp_standard.md#SS_19_3_8)」参照)
