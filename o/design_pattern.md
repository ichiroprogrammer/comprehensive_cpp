...
[イディオム](cpp_idioms.md#SS_17_1)  

- [ガード節(Early Return)](cpp_idioms.md#SS_17_1_1)
- [前方宣言ヘッダ(`_fwd.h`)](cpp_idioms.md#SS_17_1_2)
- [RAII(scoped guard)](cpp_idioms.md#SS_17_1_3)
- [Copy-And-Swap](cpp_idioms.md#SS_17_1_4)
- [CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_17_1_5)
- [Accessor](cpp_idioms.md#SS_17_1_6)
- [Immutable](cpp_idioms.md#SS_17_1_7)
- [NVI(non virtual interface)](cpp_idioms.md#SS_17_1_8)

[実装パターン](cpp_idioms.md#SS_17_2)

- [Pimpl](cpp_idioms.md#SS_17_2_1)
- [lightweight Pimpl](cpp_idioms.md#SS_17_2_2)
- [BitmaskType](cpp_idioms.md#SS_17_2_3)
- [Future](cpp_idioms.md#SS_17_2_4)
- [Null Object](cpp_idioms.md#SS_17_2_5)
- [Cでのクラス表現](cpp_idioms.md#SS_17_2_6)

[オブジェクト生成系デザインパターン](design_pattern.md#SS_8_1)

- [Singleton](design_pattern.md#SS_8_1_1)
- [Named Constructor](design_pattern.md#SS_8_1_2)
- [Clone(仮想コンストラクタ)](design_pattern.md#SS_8_1_3)
- [Factory](design_pattern.md#SS_8_1_4)

[オブジェクトの動作/協調に関するデザインパターン](design_pattern.md#SS_8_2)

- [Templateメソッド](design_pattern.md#SS_8_2_1)
- [Strategy](design_pattern.md#SS_8_2_2)
- [State](design_pattern.md#SS_8_2_3)
- [Observer](design_pattern.md#SS_8_2_4)
- [Visitor](design_pattern.md#SS_8_2_5)

[アーキテクチャパターン(システムレベルの構造)](design_pattern.md#SS_8_3)

- [DI(dependency injection)](design_pattern.md#SS_8_3_1)
- [MVC](design_pattern.md#SS_8_3_2)
...
## 8.1 オブジェクト生成系デザインパターン <a id="SS_8_1"></a>
### 8.1.1 Singleton <a id="SS_8_1_1"></a>
...
(「[Named Constructor](design_pattern.md#SS_8_1_2)」参照)と呼ばれる。

[演習-Singleton](exercise_q.md#SS_18_9_14)  

### 8.1.2 Named Constructor <a id="SS_8_1_2"></a>
Named Connstructorは、[Singleton](design_pattern.md#SS_8_1_1)のようなオブジェクトを複数、生成するためのパターンである。
...
次に示したのは「[Factory](design_pattern.md#SS_8_1_4)」の例にこのパターンを適応したコードである。
...
[演習-Named Constructor](exercise_q.md#SS_18_9_19)  

### 8.1.3 Clone(仮想コンストラクタ) <a id="SS_8_1_3"></a>
オブジェクトコピーによる[スライシング](cpp_idioms.md#SS_17_12_3)を回避するためのイデオムである。
...
[演習-Clone](exercise_q.md#SS_18_9_8)  

### 8.1.4 Factory <a id="SS_8_1_4"></a>
...
DI(「[DI(dependency injection)](design_pattern.md#SS_8_3_1)」参照)と組み合わせて使われることが多い。

「[Templateメソッド](design_pattern.md#SS_8_2_1)」の例にFactoryを適用したソースコードを下記する。
...
[演習-Factory](exercise_q.md#SS_18_9_18)  

## 8.2 オブジェクトの動作/協調に関するデザインパターン <a id="SS_8_2"></a>

### 8.2.1 Templateメソッド <a id="SS_8_2_1"></a>
...
この性質は、[Factory](design_pattern.md#SS_8_1_4)や[Named Constructor](design_pattern.md#SS_8_1_2)の実装には不可欠であるが、
...
[演習-Templateメソッド](exercise_q.md#SS_18_9_17)  

### 8.2.2 Strategy <a id="SS_8_2_2"></a>
関数f(args)の振る舞いが、
...
その属性の追加に対して「[オープン・クローズドの原則(OCP)](solid.md#SS_7_2)」に対応した構造となった。
...
あるいは、[DI(dependency injection)](design_pattern.md#SS_8_3_1)と組み合わせて、下記のような改善も有用である。
...
[演習-Strategy](exercise_q.md#SS_18_9_21)  

### 8.2.3 State <a id="SS_8_2_3"></a>
Stateは、オブジェクトの状態と、それに伴う振る舞いを分離して記述するためのパターンである。
これにより状態の追加、削減、変更に伴う修正範囲が限定される
(「[オープン・クローズドの原則(OCP)](solid.md#SS_7_2)」参照)。
...
[演習-State](exercise_q.md#SS_18_9_15)  

### 8.2.4 Observer <a id="SS_8_2_4"></a>
...
GUIアプリケーションを[MVC](design_pattern.md#SS_8_3_2)で実装する場合のModelがSubjectであり、
ViewがObserverNである。
...
[演習-Observer](exercise_q.md#SS_18_9_24)  

### 8.2.5 Visitor <a id="SS_8_2_5"></a>
...
SRP(「[単一責任の原則(SRP)](solid.md#SS_7_1)」)に反するため、
...
これを改めるためには、「[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_17_1_5)」が必要になる。
...
単体テストが容易になる例である(「[DI(dependency injection)](design_pattern.md#SS_8_3_1)」参照)。
...
[演習-Visitor](exercise_q.md#SS_18_9_22)  

### 8.2.6 Proxy <a id="SS_8_2_6"></a>
Proxyとは代理人という意味で、
...
[演習-Proxy](exercise_q.md#SS_18_9_20)  


## 8.3 アーキテクチャパターン(システムレベルの構造) <a id="SS_8_3"></a>

### 8.3.1 DI(dependency injection) <a id="SS_8_3_1"></a>
メンバ関数内でクラスDependedのオブジェクトを直接、生成する
(もしくは[Singleton](design_pattern.md#SS_8_1_1)オブジェクトや静的オブジェクト(std::coutやstd::cin等)に直接アクセスする)
クラスNotDIがあるとする。
...
[演習-DI](exercise_q.md#SS_18_9_13)  


### 8.3.2 MVC <a id="SS_8_3_2"></a>
...
ViewはModelの[Observer](design_pattern.md#SS_8_2_4)であるため、ModelはViewへ依存しない。
...
[演習-デザインパターン選択1](exercise_q.md#SS_18_9_25)  
[演習-デザインパターン選択2](exercise_q.md#SS_18_9_26)  
[演習-デザインパターン選択3](exercise_q.md#SS_18_9_27)  
