...
|機能                                                          |説明                                                                        |
|:-------------------------------------------------------------|:---------------------------------------------------------------------------|
|[用語解説|型推論](---)(auto)                                  |変数や、式の型の推論                                                        |
|[decltype](---)                                               |式の型を取得                                                                |
|[用語解説|構文|範囲for文](---)                                |インデックス変数なしのfor文                                                 |
...
|[用語解説|enum|スコープドenum](---)                          |スコープを持ち、型付の強いenum。                                           |
...
|[decltype(auto)](---)                               |decltypeの規則による変数の[用語解説|型推論](---)                                 |
|[言語機能|ラムダ式](---)の初期化キャプチャ          |キャプチャに代入構文を導入し、一つの変数に複数のキャプチャ方法を指定可能にする   |
|[ジェネリックラムダ](---)                           |ラムダ式のパラメータを auto にすることで、ジェネリックな関数呼び出しに           |
|[template強化機能|変数テンプレート](---)            |変数定義時のテンプレート指定を可能に                                             |
...
|[constexpr|constexprラムダ](---)             |ラムダ式の関数オブジェクトのconstexpr指定を可能に                                                  |
