...
|[オブジェクト生成と初期化|初期化子リストコンストラクタ](---)  |`vector<int>` v = {1, 2, 3}; など。                                           |
|[一様初期化](---)                                          　 |コンストラクタの呼び出しを、波カッコで行う。|vector<int> v{1, 2, 3};        |
|[expression|rvalue](---)/[moveセマンティクス](---)            |[オブジェクトと生成|オブジェクトの所有権](---)の移転、高速化。              |
...
|nullptr                                                       |ヌルポインタを表すポインタ[用語解説|リテラル](---)                          |
...
|機能                                                          |説明                                                                      |
|:-------------------------------------------------------------|:-------------------------------------------------------------------------|
|[型とインスタンス|特殊メンバ関数](---)のdefault/delete 宣言|自動定義される特殊関数の制御                                                 |
...
|[用語解説|リテラル|生文字列リテラル](---) |文字列リテラルにRプレフィックスを付けることで、エスケープシーケンスを無視する。  |
