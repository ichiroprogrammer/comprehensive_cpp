...
TEST_F(SolidISP_A, TestScore_LoadCSV)
{
...
TEST_F(SolidISP_A, TestScore_AddScore)
{
    TestScore ts = LoadCSV(test_score_org_);
...
TEST_F(SolidISP_A, TestScore_GetScore)
{
    TestScore ts = LoadCSV(test_score_org_);
...
TEST_F(SolidISP_A, TestScore_StoreCSV)
{
    TestScore ts = LoadCSV(test_score_org_);
...
TEST_F(SolidISP_A, TestScore_Average)
{
    TestScore ts = LoadCSV(test_score_org_);
